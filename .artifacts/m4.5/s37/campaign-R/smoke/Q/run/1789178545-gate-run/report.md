...
date: 1789178545 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S37 ticketed-DEL RSS/tail row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 (off) · device-probe auto
...
- data root: /home/kcaicedo/bench-data/s37/batch32-smoke-ysipbvi1/Q (ext4)
- durable arms: frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 (off) · device-probe auto
- --only-s37: every other row was skipped; their gate keys are absent
- s37 ticketed-DEL row (ADR-0093 A13): 4 cells · 1 replicates (ABBA) · tiered always, MEM-BUDGET 128mb/cell, 1000000 keys × 1 KiB filled per leg, then 2 cycles × 12288 keys: SET the window (tickets on B), DEL the window (pipeline 1, 64 conns), VmRSS sampled every 20 ms through the DEL · A = tiered-shadow-overwrite no, B = yes + tiered-shadow-reconcile no (tickets held open until DEL) — the same binary; per-cycle readings on the raw line
- s37 ticketed-DEL B vs A (c64, pipeline 1): DEL ops 0.233 × · p50 3.783 × · p99 2.976 × · p99.9 1.679 × · B p99 7759 µs / p99.9 11551 µs / max 12908 µs · ticketed share B 0.933 (A 0.000) · tickets/SET B 0.933 · refused B 0 · RSS growth through a DEL pass A 0 B / B 0 B · RSS end−base A -819200 B / B -1032192 B (medians of 1 pairs; per-leg = medians over cycles, growth = worst cycle)
...
```
rep0 A cycle0 keys@0: sets=12288 tickets=0 (0.000/set) set_fallbacks=0 dels=12288 forced=0 (0.000/del) refused=0 pending_after=0 reads_fg=0 del_ops/s=75931 del_p50_us=675 del_p99_us=1727 del_p999_us=2703 del_max_us=2983 rss_before_del=292147200 rss_peak_del=292147200 rss_after_del=292147200 (growth 0)
rep0 A cycle1 keys@12288: sets=12288 tickets=0 (0.000/set) set_fallbacks=0 dels=12288 forced=0 (0.000/del) refused=0 pending_after=0 reads_fg=0 del_ops/s=64334 del_p50_us=797 del_p99_us=2607 del_p999_us=6879 del_max_us=7653 rss_before_del=290967552 rss_peak_del=290967552 rss_after_del=290967552 (growth 0)
rep0 A leg: cycles=2 sets=24576 tickets=0 set_fallbacks=0 dels=24576 forced=0 (0.000/del) refused=0 pending_after=0 reads_fg=0 del_ops/s=75931 del_p50_us=797 del_p99_us=2607 del_p999_us=6879 del_max_us=7653 del_rss_growth=0 rss_base=291786752 rss_end=290967552 (delta -819200)
rep0 B cycle0 keys@0: sets=12288 tickets=12288 (1.000/set) set_fallbacks=0 dels=12288 forced=12288 (1.000/del) refused=0 pending_after=0 reads_fg=0 del_ops/s=17666 del_p50_us=2911 del_p99_us=7103 del_p999_us=10911 del_max_us=12052 rss_before_del=292139008 rss_peak_del=292139008 rss_after_del=292139008 (growth 0)
rep0 B cycle1 keys@12288: sets=12288 tickets=10646 (0.866/set) set_fallbacks=0 dels=12288 forced=10646 (0.866/del) refused=0 pending_after=0 reads_fg=0 del_ops/s=16697 del_p50_us=3015 del_p99_us=7759 del_p999_us=11551 del_max_us=12908 rss_before_del=290746368 rss_peak_del=290746368 rss_after_del=290746368 (growth 0)
rep0 B leg: cycles=2 sets=24576 tickets=22934 set_fallbacks=0 dels=24576 forced=22934 (0.933/del) refused=0 pending_after=0 reads_fg=0 del_ops/s=17666 del_p50_us=3015 del_p99_us=7759 del_p999_us=11551 del_max_us=12908 del_rss_growth=0 rss_base=291778560 rss_end=290746368 (delta -1032192)
```
