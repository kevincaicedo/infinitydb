...
date: 1787332733 (unix) · cells: 4 · duration: 10s · ONLY-ALWAYS (A/B leg; frames-in-flight 3 · barrier-class fua · staging-mib 2)
env-check: OK
...
- always row: 19396497 gated acks / 624563 fsyncs = ratio 31.1; fsync latency p50/p99/p999 = 135/343/439 us (HDR ~3% quantization); log_writes_per_iter 0.319 (624456 frames / 1958912 iterations); group formation p50/p99 = 58/117 records vs ~256 available in-flight writes/cell = 0.23x (M2.5-S07 gate: >= 0.8x)
...
| always grouped writes | >= 300000 w/s | 1766565.15 | PASS |
...
| One log write per iteration | <= 1 writes/iter | 0.32 | PASS |
| acks/fsync grouping ratio above floor | >= 2 acks per fsync | 31.06 | PASS (informational) |
