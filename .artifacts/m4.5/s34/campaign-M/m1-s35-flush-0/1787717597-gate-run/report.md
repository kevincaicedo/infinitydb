...
date: 1787717597 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 (off) · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.910–1.910 · client p50 1.852–1.852 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
| S35: N-cell vs 1-cell always client p50 ratio (informational since 2026-08-22 — carries the pipeline's seal wait at K ≥ 2) | <= 1.3 x (N-cell p50 / 1-cell p50 at 32 conns, per-replicate median on the 0.4 % client histogram; FLUSH read 1.8, FUA K = 1 1.45, K = 3 1.25–1.38 on the 3 % instrument) | 1.85 | FAIL (informational) |
...
```
rep0 4c c32  ops/s=6377     p50_us=4975   mean_us=5015   p99_us=8191    max_us=16777    barrier_p50_us=2687  barrier_p99_us=4735   p50/barrier=1.85 frames_in_flight_max=1 acks/fsync=4.3 frames=52409 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=13
rep0 4c c256 ops/s=53272    p50_us=4959   mean_us=4801   p99_us=7199    max_us=17071    barrier_p50_us=2687  barrier_p99_us=4479   frames_in_flight_max=1 acks/fsync=36.5 frames=108796 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=80
rep0 4c read c64 P16 ops/s=1643434  p50_us=629    p99_us=941     p999_us=1043    nils=678289
rep0 1c c32  ops/s=11665    p50_us=2687   mean_us=2742   p99_us=4127    max_us=12165    barrier_p50_us=1407  barrier_p99_us=2239   p50/barrier=1.91 frames_in_flight_max=1 acks/fsync=16.0 frames=13191 parked=0 write_stall_p99_us=89 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=5 4c/1c: p50=1.852 barrier=1.910
```
