...
date: 1787718101 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 (off) · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.585–1.585 · client p50 1.531–1.531 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
| S35: N-cell vs 1-cell always client p50 ratio (informational since 2026-08-22 — carries the pipeline's seal wait at K ≥ 2) | <= 1.3 x (N-cell p50 / 1-cell p50 at 32 conns, per-replicate median on the 0.4 % client histogram; FLUSH read 1.8, FUA K = 1 1.45, K = 3 1.25–1.38 on the 3 % instrument) | 1.53 | FAIL (informational) |
...
```
rep0 4c c32  ops/s=6403     p50_us=4959   mean_us=4994   p99_us=8111    max_us=15640    barrier_p50_us=2687  barrier_p99_us=4607   p50/barrier=1.85 frames_in_flight_max=1 acks/fsync=4.3 frames=52017 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=10
rep0 4c c256 ops/s=44460    p50_us=6063   mean_us=5753   p99_us=8255    max_us=16601    barrier_p50_us=3071  barrier_p99_us=4607   frames_in_flight_max=1 acks/fsync=36.3 frames=85256 parked=0 write_stall_p99_us=623 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=114
rep0 4c read c64 P16 ops/s=1688206  p50_us=611    p99_us=835     p999_us=935     nils=1128471
rep0 1c c32  ops/s=9779     p50_us=3239   mean_us=3271   p99_us=4639    max_us=12674    barrier_p50_us=1695  barrier_p99_us=2687   p50/barrier=1.91 frames_in_flight_max=1 acks/fsync=16.0 frames=9324 parked=0 write_stall_p99_us=91 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=28 4c/1c: p50=1.531 barrier=1.585
```
