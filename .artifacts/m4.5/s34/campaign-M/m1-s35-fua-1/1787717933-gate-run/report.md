...
date: 1787717933 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class fua · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 (off) · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.289–1.289 · client p50 1.377–1.377 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
| S35: always p50 over the barrier p50 at 32 conns | <= 1.3 x (client p50 / barrier p50; plan AC 1.2 + 0.1-window loop overhead — K = 1 reads ~1.85) | 1.20 | PASS |
...
| S35: N-cell vs 1-cell always client p50 ratio (informational since 2026-08-22 — carries the pipeline's seal wait at K ≥ 2) | <= 1.3 x (N-cell p50 / 1-cell p50 at 32 conns, per-replicate median on the 0.4 % client histogram; FLUSH read 1.8, FUA K = 1 1.45, K = 3 1.25–1.38 on the 3 % instrument) | 1.38 | FAIL (informational) |
...
```
rep0 4c c32  ops/s=39147    p50_us=731    mean_us=816    p99_us=1935    max_us=19073    barrier_p50_us=607   barrier_p99_us=1407   p50/barrier=1.20 frames_in_flight_max=3 acks/fsync=2.2 frames=183423 parked=0 write_stall_p99_us=1471 padding_pct=51.2 waits_fill=2546 waits_group=0 round_target=13
rep0 4c c256 ops/s=94329    p50_us=1195   mean_us=2711   p99_us=26687   max_us=41152    barrier_p50_us=655   barrier_p99_us=15871  frames_in_flight_max=3 acks/fsync=14.7 frames=92958 parked=0 write_stall_p99_us=15871 padding_pct=12.5 waits_fill=1 waits_group=0 round_target=86
rep0 4c read c64 P16 ops/s=1598110  p50_us=597    p99_us=973     p999_us=1047    nils=6087
rep0 1c c32  ops/s=51981    p50_us=531    mean_us=615    p99_us=1271    max_us=107143   barrier_p50_us=471   barrier_p99_us=1279   p50/barrier=1.13 frames_in_flight_max=3 acks/fsync=22.9 frames=26112 parked=0 write_stall_p99_us=1279 padding_pct=9.7 waits_fill=1 waits_group=0 round_target=32 4c/1c: p50=1.377 barrier=1.289
```
