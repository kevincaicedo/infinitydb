...
date: 1787717765 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class fua · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 (off) · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.289–1.289 · client p50 1.389–1.389 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
```
rep0 4c c32  ops/s=39080    p50_us=735    mean_us=818    p99_us=1939    max_us=15961    barrier_p50_us=607   barrier_p99_us=1439   p50/barrier=1.21 frames_in_flight_max=3 acks/fsync=2.2 frames=181834 parked=0 write_stall_p99_us=1503 padding_pct=51.2 waits_fill=2345 waits_group=0 round_target=12
rep0 4c c256 ops/s=214103   p50_us=1103   mean_us=1194   p99_us=2663    max_us=12262    barrier_p50_us=655   barrier_p99_us=1727   frames_in_flight_max=3 acks/fsync=14.7 frames=174251 parked=0 write_stall_p99_us=1759 padding_pct=12.5 waits_fill=5 waits_group=0 round_target=63
rep0 4c read c64 P16 ops/s=1476968  p50_us=553    p99_us=1343    p999_us=1579    nils=0
rep0 1c c32  ops/s=56405    p50_us=529    mean_us=566    p99_us=1275    max_us=12558    barrier_p50_us=471   barrier_p99_us=1279   p50/barrier=1.12 frames_in_flight_max=3 acks/fsync=22.4 frames=28456 parked=0 write_stall_p99_us=1279 padding_pct=9.7 waits_fill=2 waits_group=0 round_target=1 4c/1c: p50=1.389 barrier=1.289
```
