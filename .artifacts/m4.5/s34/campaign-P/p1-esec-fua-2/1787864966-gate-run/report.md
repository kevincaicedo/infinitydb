...
date: 1787864966 (unix) · cells: 4 · duration: 10s · ONLY-EVERYSEC (A/B leg; frames-in-flight auto (fua 3 / flush 1) · barrier-class fua · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 (off) · device-probe off)
env-check: OK
...
- everysec row: memory-ns 2406045 ops/s (spread 3.31%) vs everysec 1234546 ops/s (spread 67.11%) — signed penalty +48.69%; p999 785 → 101887 µs (§18 flat-tails supporting); fsync latency p50/p99/p999 = 4735/330899/380427 us; both namespaces named (both ride the pump — the row isolates durability cost)
...
| everysec penalty vs memory mode | < 10 % | 48.69 | FAIL |
