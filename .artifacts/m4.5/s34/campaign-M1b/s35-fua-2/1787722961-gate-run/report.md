...
date: 1787722961 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class fua · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 (off) · device-probe off
env-check: OK
...
| S35: always p50 over the barrier p50 at 32 conns | <= 1.3 x (client p50 / barrier p50; plan AC 1.2 + 0.1-window loop overhead — K = 1 reads ~1.85) | 1.18 | PASS |
| S35: N-cell vs 1-cell barrier p50 ratio (device characterization — informational since the ADR-0087 fourth amendment, 2026-08-22) | <= 1.3 x (N-cell barrier p50 / 1-cell barrier p50 at 32 conns, per-replicate median; FLUSH read ~1.8, FUA read 1.35–1.54 at every K on 08-22 — qd4 vs qd1 on the device) | 1.32 | FAIL (informational) |
| S35: N-cell vs 1-cell always client p50 ratio (informational since 2026-08-22 — carries the pipeline's seal wait at K ≥ 2) | <= 1.3 x (N-cell p50 / 1-cell p50 at 32 conns, per-replicate median on the 0.4 % client histogram; FLUSH read 1.8, FUA K = 1 1.45, K = 3 1.25–1.38 on the 3 % instrument) | 1.39 | FAIL (informational) |
...
```
rep0 4c c32  ops/s=39136    p50_us=737    mean_us=816    p99_us=1923    max_us=12088    barrier_p50_us=623   barrier_p99_us=1439   p50/barrier=1.18 frames_in_flight_max=3 acks/fsync=2.2 frames=182636 parked=0 write_stall_p99_us=1503 padding_pct=51.2 waits_fill=2621 waits_group=0 round_target=10
rep0 4c c256 ops/s=120059   p50_us=1131   mean_us=2130   p99_us=26239   max_us=38065    barrier_p50_us=655   barrier_p99_us=2559   frames_in_flight_max=3 acks/fsync=14.7 frames=110584 parked=0 write_stall_p99_us=2559 padding_pct=12.5 waits_fill=2 waits_group=0 round_target=79
rep0 4c read c64 P16 ops/s=1595520  p50_us=635    p99_us=967     p999_us=1035    nils=0 filled=true
rep0 1c c32  ops/s=56249    p50_us=529    mean_us=568    p99_us=1271    max_us=11301    barrier_p50_us=471   barrier_p99_us=1279   p50/barrier=1.12 frames_in_flight_max=3 acks/fsync=21.8 frames=29064 parked=0 write_stall_p99_us=1279 padding_pct=9.9 waits_fill=3 waits_group=0 round_target=1 4c/1c: p50=1.393 barrier=1.323
```
