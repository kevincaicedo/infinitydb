...
date: 1787722541 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 (off) · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.572–1.572 · client p50 2.139–2.139 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
```
rep0 4c c32  ops/s=9558     p50_us=3215   mean_us=3346   p99_us=5823    max_us=18262    barrier_p50_us=2111  barrier_p99_us=3839   p50/barrier=1.52 frames_in_flight_max=1 acks/fsync=6.4 frames=49088 parked=0 write_stall_p99_us=623 padding_pct=0.0 waits_fill=0 waits_group=17748 round_target=20
rep0 4c c256 ops/s=65804    p50_us=3879   mean_us=3887   p99_us=6879    max_us=15700    barrier_p50_us=2367  barrier_p99_us=3775   frames_in_flight_max=1 acks/fsync=45.7 frames=96994 parked=0 write_stall_p99_us=311 padding_pct=0.0 waits_fill=0 waits_group=17396 round_target=120
rep0 4c read c64 P16 ops/s=1606112  p50_us=629    p99_us=969     p999_us=1043    nils=0 filled=true
rep0 1c c32  ops/s=20782    p50_us=1503   mean_us=1539   p99_us=2143    max_us=11347    barrier_p50_us=1343  barrier_p99_us=1983   p50/barrier=1.12 frames_in_flight_max=1 acks/fsync=32.0 frames=7751 parked=0 write_stall_p99_us=79 padding_pct=0.0 waits_fill=0 waits_group=14 round_target=32 4c/1c: p50=2.139 barrier=1.572
```
