...
date: 1787722121 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class fua · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 (off) · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.346–1.346 · client p50 1.402–1.402 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
```
rep0 4c c32  ops/s=39110    p50_us=739    mean_us=817    p99_us=1931    max_us=13703    barrier_p50_us=623   barrier_p99_us=1407   p50/barrier=1.19 frames_in_flight_max=3 acks/fsync=2.2 frames=183516 parked=0 write_stall_p99_us=1471 padding_pct=51.2 waits_fill=2333 waits_group=0 round_target=10
rep0 4c c256 ops/s=214651   p50_us=1103   mean_us=1191   p99_us=2671    max_us=12065    barrier_p50_us=655   barrier_p99_us=1727   frames_in_flight_max=3 acks/fsync=14.7 frames=174457 parked=0 write_stall_p99_us=1759 padding_pct=12.5 waits_fill=4 waits_group=0 round_target=84
rep0 4c read c64 P16 ops/s=1594587  p50_us=603    p99_us=959     p999_us=1013    nils=0 filled=true
rep0 1c c32  ops/s=56310    p50_us=527    mean_us=567    p99_us=1267    max_us=11407    barrier_p50_us=463   barrier_p99_us=1279   p50/barrier=1.14 frames_in_flight_max=3 acks/fsync=22.7 frames=28189 parked=0 write_stall_p99_us=1279 padding_pct=10.2 waits_fill=3 waits_group=0 round_target=31 4c/1c: p50=1.402 barrier=1.346
```
