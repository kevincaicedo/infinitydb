...
date: 1787722331 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class fua · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 (off) · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.323–1.323 · client p50 1.395–1.395 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
```
rep0 4c c32  ops/s=36982    p50_us=741    mean_us=864    p99_us=3727    max_us=20496    barrier_p50_us=623   barrier_p99_us=1407   p50/barrier=1.19 frames_in_flight_max=3 acks/fsync=2.2 frames=170817 parked=0 write_stall_p99_us=1471 padding_pct=51.2 waits_fill=2333 waits_group=0 round_target=9
rep0 4c c256 ops/s=42823    p50_us=1151   mean_us=5974   p99_us=64639   max_us=247752   barrier_p50_us=639   barrier_p99_us=18431  frames_in_flight_max=3 acks/fsync=14.7 frames=39450 parked=0 write_stall_p99_us=17919 padding_pct=12.5 waits_fill=1 waits_group=0 round_target=81
rep0 4c read c64 P16 ops/s=1596257  p50_us=669    p99_us=913     p999_us=1031    nils=0 filled=true
rep0 1c c32  ops/s=55175    p50_us=531    mean_us=579    p99_us=1271    max_us=11514    barrier_p50_us=471   barrier_p99_us=1279   p50/barrier=1.13 frames_in_flight_max=3 acks/fsync=22.8 frames=27507 parked=0 write_stall_p99_us=1279 padding_pct=9.7 waits_fill=10 waits_group=0 round_target=32 4c/1c: p50=1.395 barrier=1.323
```
