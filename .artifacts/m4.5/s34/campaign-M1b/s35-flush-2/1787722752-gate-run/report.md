...
date: 1787722752 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 (off) · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.572–1.572 · client p50 2.096–2.096 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
```
rep0 4c c32  ops/s=9643     p50_us=3151   mean_us=3316   p99_us=5775    max_us=18425    barrier_p50_us=2111  barrier_p99_us=3775   p50/barrier=1.49 frames_in_flight_max=1 acks/fsync=6.4 frames=49049 parked=0 write_stall_p99_us=623 padding_pct=0.0 waits_fill=0 waits_group=17544 round_target=11
rep0 4c c256 ops/s=67766    p50_us=3799   mean_us=3775   p99_us=6815    max_us=16270    barrier_p50_us=2303  barrier_p99_us=3775   frames_in_flight_max=1 acks/fsync=46.5 frames=99162 parked=0 write_stall_p99_us=295 padding_pct=0.0 waits_fill=0 waits_group=17496 round_target=54
rep0 4c read c64 P16 ops/s=1591835  p50_us=701    p99_us=969     p999_us=1063    nils=0 filled=true
rep0 1c c32  ops/s=20794    p50_us=1503   mean_us=1538   p99_us=2143    max_us=10966    barrier_p50_us=1343  barrier_p99_us=1983   p50/barrier=1.12 frames_in_flight_max=1 acks/fsync=32.0 frames=7765 parked=0 write_stall_p99_us=81 padding_pct=0.0 waits_fill=0 waits_group=20 round_target=32 4c/1c: p50=2.096 barrier=1.572
```
