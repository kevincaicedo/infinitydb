...
date: 1787333013 (unix) · cells: 4 · duration: 10s · ONLY-ALWAYS (A/B leg; frames-in-flight 4 · barrier-class fua · staging-mib 4)
env-check: OK
...
- always row: 19050943 gated acks / 604541 fsyncs = ratio 31.5; fsync latency p50/p99/p999 = 93/319/439 us (HDR ~3% quantization); log_writes_per_iter 0.295 (604361 frames / 2045952 iterations); group formation p50/p99 = 41/111 records vs ~256 available in-flight writes/cell = 0.16x (M2.5-S07 gate: >= 0.8x)
...
| always grouped writes | >= 300000 w/s | 1733260.33 | PASS |
...
| One log write per iteration | <= 1 writes/iter | 0.30 | PASS |
| acks/fsync grouping ratio above floor | >= 2 acks per fsync | 31.51 | PASS (informational) |
