...
|---|---|---|---:|---|
| redis | host | taskset from util-linux 2.41.3 | 244.3 | `taskset -c 0 redis-server --port 7400 --save '' --appendonly yes --appendfsync everysec --dir /home/kcaicedo/bench-data/s40/data/redis` |
| infinitydb | host | infinityd 9c31a18 (git 9c31a1859041, x86_64-unknown-linux-gnu) | 323.6 | `target/release/infinityd --port 7401 --cells 4 --pin-start 0 --data-dir /home/kcaicedo/bench-data/s40/data/infinitydb --conn-default-ns cmp` |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| redis | set | 1 | 96395 | 0.96 | 0.202 | 0.143 | 3.167 | 5.023 | 602.111 | 50 | 7766.8 | 239.4 |
| infinitydb | set | 1 | 98758 | 0.99 | 0.060 | 0.055 | 0.127 | 0.423 | 23.423 | 108 | 7584.1 | 323.6 |
