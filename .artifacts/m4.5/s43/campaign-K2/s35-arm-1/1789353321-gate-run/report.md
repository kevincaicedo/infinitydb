...
date: 1789353321 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 250 · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.572–1.572 · client p50 2.125–2.125 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
| S35: always p50 over the barrier p50 at 32 conns | <= 1.3 x (client p50 / barrier p50; plan AC 1.2 + 0.1-window loop overhead — K = 1 reads ~1.85) | 1.55 | FAIL |
...
| S35: N-cell vs 1-cell always client p50 ratio (informational since 2026-08-22 — carries the pipeline's seal wait at K ≥ 2) | <= 1.3 x (N-cell p50 / 1-cell p50 at 32 conns, per-replicate median on the 0.4 % client histogram; FLUSH read 1.8, FUA K = 1 1.45, K = 3 1.25–1.38 on the 3 % instrument) | 2.13 | FAIL (informational) |
...
```
rep0 4c c32  ops/s=9451     p50_us=3271   mean_us=3383   p99_us=5983    max_us=19063    barrier_p50_us=2111  barrier_p99_us=3839   p50/barrier=1.55 frames_in_flight_max=1 acks/fsync=6.4 frames=49643 parked=0 write_stall_p99_us=623 padding_pct=0.0 waits_fill=0 waits_group=17713 round_target=12
rep0 4c c256 ops/s=71278    p50_us=3775   mean_us=3589   p99_us=5999    max_us=16503    barrier_p50_us=2367  barrier_p99_us=3775   frames_in_flight_max=1 acks/fsync=48.9 frames=87284 parked=0 write_stall_p99_us=287 padding_pct=0.0 waits_fill=0 waits_group=17384 round_target=159
rep0 4c read c64 P16 ops/s=1609672  p50_us=627    p99_us=855     p999_us=967     nils=226557 filled=false
rep0 1c c32  ops/s=20421    p50_us=1539   mean_us=1566   p99_us=2247    max_us=15720    barrier_p50_us=1343  barrier_p99_us=2047   p50/barrier=1.15 frames_in_flight_max=1 acks/fsync=32.0 frames=7725 parked=0 write_stall_p99_us=83 padding_pct=0.0 waits_fill=0 waits_group=21 round_target=32 4c/1c: p50=2.125 barrier=1.572
```
