...
date: 1789354330 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.912–1.912 · client p50 1.884–1.884 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
| S35: always p50 over the barrier p50 at 32 conns | <= 1.3 x (client p50 / barrier p50; plan AC 1.2 + 0.1-window loop overhead — K = 1 reads ~1.85) | 1.79 | FAIL |
...
| S35: N-cell vs 1-cell always client p50 ratio (informational since 2026-08-22 — carries the pipeline's seal wait at K ≥ 2) | <= 1.3 x (N-cell p50 / 1-cell p50 at 32 conns, per-replicate median on the 0.4 % client histogram; FLUSH read 1.8, FUA K = 1 1.45, K = 3 1.25–1.38 on the 3 % instrument) | 1.88 | FAIL (informational) |
...
```
rep0 4c c32  ops/s=6418     p50_us=4927   mean_us=4982   p99_us=8223    max_us=15813    barrier_p50_us=2751  barrier_p99_us=4735   p50/barrier=1.79 frames_in_flight_max=1 acks/fsync=4.3 frames=52658 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=15
rep0 4c c256 ops/s=53865    p50_us=4959   mean_us=4749   p99_us=7119    max_us=15439    barrier_p50_us=2687  barrier_p99_us=4479   frames_in_flight_max=1 acks/fsync=36.3 frames=105331 parked=0 write_stall_p99_us=623 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=91
rep0 4c read c64 P16 ops/s=1614217  p50_us=661    p99_us=941     p999_us=1075    nils=667958 filled=false
rep0 1c c32  ops/s=11948    p50_us=2615   mean_us=2676   p99_us=4063    max_us=12455    barrier_p50_us=1439  barrier_p99_us=2239   p50/barrier=1.82 frames_in_flight_max=1 acks/fsync=16.0 frames=11225 parked=0 write_stall_p99_us=91 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=2 4c/1c: p50=1.884 barrier=1.912
```
