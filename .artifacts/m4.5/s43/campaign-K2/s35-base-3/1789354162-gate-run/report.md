...
date: 1789354162 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.910–1.910 · client p50 1.839–1.839 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
| S35: always p50 over the barrier p50 at 32 conns | <= 1.3 x (client p50 / barrier p50; plan AC 1.2 + 0.1-window loop overhead — K = 1 reads ~1.85) | 1.83 | FAIL |
...
| S35: N-cell vs 1-cell always client p50 ratio (informational since 2026-08-22 — carries the pipeline's seal wait at K ≥ 2) | <= 1.3 x (N-cell p50 / 1-cell p50 at 32 conns, per-replicate median on the 0.4 % client histogram; FLUSH read 1.8, FUA K = 1 1.45, K = 3 1.25–1.38 on the 3 % instrument) | 1.84 | FAIL (informational) |
...
```
rep0 4c c32  ops/s=6398     p50_us=4927   mean_us=4998   p99_us=8159    max_us=15885    barrier_p50_us=2687  barrier_p99_us=4607   p50/barrier=1.83 frames_in_flight_max=1 acks/fsync=4.3 frames=52473 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=19
rep0 4c c256 ops/s=16622    p50_us=5311   mean_us=15390  p99_us=105215  max_us=325903   barrier_p50_us=2751  barrier_p99_us=59391  frames_in_flight_max=1 acks/fsync=35.2 frames=44030 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=119
rep0 4c read c64 P16 ops/s=1850340  p50_us=537    p99_us=873     p999_us=997     nils=4764865 filled=false
rep0 1c c32  ops/s=12638    p50_us=2679   mean_us=2531   p99_us=4063    max_us=10052    barrier_p50_us=1407  barrier_p99_us=2111   p50/barrier=1.90 frames_in_flight_max=1 acks/fsync=17.7 frames=10367 parked=0 write_stall_p99_us=87 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=3 4c/1c: p50=1.839 barrier=1.910
```
