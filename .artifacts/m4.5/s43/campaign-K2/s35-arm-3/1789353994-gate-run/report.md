...
date: 1789353994 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 250 · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.572–1.572 · client p50 2.128–2.128 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
| S35: always p50 over the barrier p50 at 32 conns | <= 1.3 x (client p50 / barrier p50; plan AC 1.2 + 0.1-window loop overhead — K = 1 reads ~1.85) | 1.52 | FAIL |
...
```
rep0 4c c32  ops/s=9587     p50_us=3199   mean_us=3335   p99_us=5775    max_us=14368    barrier_p50_us=2111  barrier_p99_us=3775   p50/barrier=1.52 frames_in_flight_max=1 acks/fsync=6.4 frames=49460 parked=0 write_stall_p99_us=607 padding_pct=0.0 waits_fill=0 waits_group=17895 round_target=18
rep0 4c c256 ops/s=67761    p50_us=3823   mean_us=3775   p99_us=6767    max_us=16806    barrier_p50_us=2367  barrier_p99_us=3775   frames_in_flight_max=1 acks/fsync=46.9 frames=97446 parked=0 write_stall_p99_us=295 padding_pct=0.0 waits_fill=0 waits_group=17408 round_target=50
rep0 4c read c64 P16 ops/s=1571993  p50_us=615    p99_us=1067    p999_us=1135    nils=254880 filled=false
rep0 1c c32  ops/s=20735    p50_us=1503   mean_us=1542   p99_us=2143    max_us=15722    barrier_p50_us=1343  barrier_p99_us=1983   p50/barrier=1.12 frames_in_flight_max=1 acks/fsync=32.0 frames=7826 parked=0 write_stall_p99_us=79 padding_pct=0.0 waits_fill=0 waits_group=15 round_target=32 4c/1c: p50=2.128 barrier=1.572
```
