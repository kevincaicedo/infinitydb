...
date: 1789352984 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.912–1.912 · client p50 2.007–2.007 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
| S35: always p50 over the barrier p50 at 32 conns | <= 1.3 x (client p50 / barrier p50; plan AC 1.2 + 0.1-window loop overhead — K = 1 reads ~1.85) | 1.81 | FAIL |
...
| S35: N-cell vs 1-cell always client p50 ratio (informational since 2026-08-22 — carries the pipeline's seal wait at K ≥ 2) | <= 1.3 x (N-cell p50 / 1-cell p50 at 32 conns, per-replicate median on the 0.4 % client histogram; FLUSH read 1.8, FUA K = 1 1.45, K = 3 1.25–1.38 on the 3 % instrument) | 2.01 | FAIL (informational) |
...
```
rep0 4c c32  ops/s=6388     p50_us=4975   mean_us=5006   p99_us=8223    max_us=15725    barrier_p50_us=2751  barrier_p99_us=4863   p50/barrier=1.81 frames_in_flight_max=1 acks/fsync=4.3 frames=52180 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=13
rep0 4c c256 ops/s=51608    p50_us=5087   mean_us=4957   p99_us=7247    max_us=15092    barrier_p50_us=2687  barrier_p99_us=4479   frames_in_flight_max=1 acks/fsync=35.5 frames=102213 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=116
rep0 4c read c64 P16 ops/s=1626334  p50_us=643    p99_us=897     p999_us=1003    nils=720704 filled=false
rep0 1c c32  ops/s=10931    p50_us=2479   mean_us=2926   p99_us=17983   max_us=29557    barrier_p50_us=1439  barrier_p99_us=4351   p50/barrier=1.72 frames_in_flight_max=1 acks/fsync=16.0 frames=8506 parked=0 write_stall_p99_us=97 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=1 4c/1c: p50=2.007 barrier=1.912
```
