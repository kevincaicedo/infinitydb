#!/usr/bin/env bash
# S43 campaign K2 (2026-09-13, batch 49): re-measurement of the ADR-0092 arm after batch 43 (the hold episode ends at the issue) — base (0) vs arm (250 µs), five rounds, order alternated; campaign K's predeclared rule verbatim (README.md).
set -uo pipefail
cd /home/kcaicedo/Documents/Projects/databases/infinitydb
ROOT=$HOME/bench-data/s43/campaign-K2
