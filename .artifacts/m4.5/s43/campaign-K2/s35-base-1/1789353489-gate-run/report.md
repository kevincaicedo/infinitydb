...
date: 1789353489 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 · device-probe off
env-check: OK
...
```
rep0 4c c32  ops/s=6364     p50_us=4991   mean_us=5025   p99_us=8223    max_us=17362    barrier_p50_us=2751  barrier_p99_us=4863   p50/barrier=1.81 frames_in_flight_max=1 acks/fsync=4.3 frames=52154 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=21
rep0 4c c256 ops/s=52033    p50_us=5055   mean_us=4915   p99_us=7231    max_us=14927    barrier_p50_us=2687  barrier_p99_us=4479   frames_in_flight_max=1 acks/fsync=35.3 frames=103405 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=114
rep0 4c read c64 P16 ops/s=1622530  p50_us=629    p99_us=953     p999_us=1059    nils=739210 filled=false
rep0 1c c32  ops/s=12359    p50_us=2487   mean_us=2587   p99_us=4055    max_us=14421    barrier_p50_us=1439  barrier_p99_us=2239   p50/barrier=1.73 frames_in_flight_max=1 acks/fsync=16.0 frames=9294 parked=0 write_stall_p99_us=93 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=31 4c/1c: p50=2.007 barrier=1.912
```
