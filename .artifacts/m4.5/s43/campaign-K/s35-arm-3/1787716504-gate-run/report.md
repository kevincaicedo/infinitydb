...
date: 1787716504 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 250 · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.572–1.572 · client p50 2.133–2.133 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
```
rep0 4c c32  ops/s=9560     p50_us=3223   mean_us=3345   p99_us=5791    max_us=15104    barrier_p50_us=2111  barrier_p99_us=3775   p50/barrier=1.53 frames_in_flight_max=1 acks/fsync=6.4 frames=49220 parked=0 write_stall_p99_us=623 padding_pct=0.0 waits_fill=0 waits_group=17792 round_target=16
rep0 4c c256 ops/s=66946    p50_us=3823   mean_us=3820   p99_us=6847    max_us=15393    barrier_p50_us=2367  barrier_p99_us=3775   frames_in_flight_max=1 acks/fsync=45.8 frames=99565 parked=0 write_stall_p99_us=295 padding_pct=0.0 waits_fill=0 waits_group=17446 round_target=98
rep0 4c read c64 P16 ops/s=1636336  p50_us=649    p99_us=897     p999_us=1013    nils=293536
rep0 1c c32  ops/s=20654    p50_us=1511   mean_us=1548   p99_us=2143    max_us=11889    barrier_p50_us=1343  barrier_p99_us=1983   p50/barrier=1.13 frames_in_flight_max=1 acks/fsync=32.0 frames=7782 parked=0 write_stall_p99_us=81 padding_pct=0.0 waits_fill=0 waits_group=25 round_target=32 4c/1c: p50=2.133 barrier=1.572
```
