...
date: 1787715999 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.912–1.912 · client p50 1.944–1.944 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
| S35: N-cell vs 1-cell always client p50 ratio (informational since 2026-08-22 — carries the pipeline's seal wait at K ≥ 2) | <= 1.3 x (N-cell p50 / 1-cell p50 at 32 conns, per-replicate median on the 0.4 % client histogram; FLUSH read 1.8, FUA K = 1 1.45, K = 3 1.25–1.38 on the 3 % instrument) | 1.94 | FAIL (informational) |
...
```
rep0 4c c32  ops/s=6428     p50_us=4927   mean_us=4975   p99_us=7983    max_us=17403    barrier_p50_us=2751  barrier_p99_us=4735   p50/barrier=1.79 frames_in_flight_max=1 acks/fsync=4.3 frames=52386 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=19
rep0 4c c256 ops/s=51908    p50_us=5055   mean_us=4928   p99_us=7215    max_us=17221    barrier_p50_us=2687  barrier_p99_us=4479   frames_in_flight_max=1 acks/fsync=35.3 frames=102978 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=119
rep0 4c read c64 P16 ops/s=1658596  p50_us=565    p99_us=1013    p999_us=1075    nils=736592
rep0 1c c32  ops/s=12148    p50_us=2535   mean_us=2632   p99_us=4047    max_us=12694    barrier_p50_us=1439  barrier_p99_us=2239   p50/barrier=1.76 frames_in_flight_max=1 acks/fsync=16.0 frames=10744 parked=0 write_stall_p99_us=91 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=2 4c/1c: p50=1.944 barrier=1.912
```
