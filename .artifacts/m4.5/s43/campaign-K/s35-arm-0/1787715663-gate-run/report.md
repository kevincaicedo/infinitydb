...
date: 1787715663 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 250 · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 2.001–2.001 · client p50 2.659–2.659 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
| S35: N-cell vs 1-cell always client p50 ratio (informational since 2026-08-22 — carries the pipeline's seal wait at K ≥ 2) | <= 1.3 x (N-cell p50 / 1-cell p50 at 32 conns, per-replicate median on the 0.4 % client histogram; FLUSH read 1.8, FUA K = 1 1.45, K = 3 1.25–1.38 on the 3 % instrument) | 2.66 | FAIL (informational) |
...
```
rep0 4c c32  ops/s=7848     p50_us=4007   mean_us=4075   p99_us=6943    max_us=16728    barrier_p50_us=2687  barrier_p99_us=7935   p50/barrier=1.49 frames_in_flight_max=1 acks/fsync=6.4 frames=39110 parked=0 write_stall_p99_us=911 padding_pct=0.0 waits_fill=0 waits_group=13902 round_target=16
rep0 4c c256 ops/s=73699    p50_us=3711   mean_us=3471   p99_us=5743    max_us=14708    barrier_p50_us=2495  barrier_p99_us=4351   frames_in_flight_max=1 acks/fsync=49.6 frames=80904 parked=0 write_stall_p99_us=479 padding_pct=0.0 waits_fill=0 waits_group=17549 round_target=147
rep0 4c read c64 P16 ops/s=1620311  p50_us=673    p99_us=903     p999_us=1005    nils=213191
rep0 1c c32  ops/s=20699    p50_us=1507   mean_us=1545   p99_us=2143    max_us=12537    barrier_p50_us=1343  barrier_p99_us=1983   p50/barrier=1.12 frames_in_flight_max=1 acks/fsync=32.0 frames=7807 parked=0 write_stall_p99_us=81 padding_pct=0.0 waits_fill=0 waits_group=19 round_target=21 4c/1c: p50=2.659 barrier=2.001
```
