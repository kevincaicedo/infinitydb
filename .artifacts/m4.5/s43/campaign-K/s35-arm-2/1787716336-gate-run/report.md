...
date: 1787716336 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 250 · device-probe off
env-check: OK
...
```
rep0 4c c32  ops/s=9578     p50_us=3159   mean_us=3339   p99_us=5839    max_us=15144    barrier_p50_us=2111  barrier_p99_us=3775   p50/barrier=1.50 frames_in_flight_max=1 acks/fsync=6.4 frames=49228 parked=0 write_stall_p99_us=623 padding_pct=0.0 waits_fill=0 waits_group=17720 round_target=16
rep0 4c c256 ops/s=71484    p50_us=3759   mean_us=3578   p99_us=5999    max_us=15656    barrier_p50_us=2367  barrier_p99_us=3775   frames_in_flight_max=1 acks/fsync=49.0 frames=84679 parked=0 write_stall_p99_us=351 padding_pct=0.0 waits_fill=0 waits_group=17405 round_target=115
rep0 4c read c64 P16 ops/s=1618308  p50_us=641    p99_us=959     p999_us=1027    nils=225131
rep0 1c c32  ops/s=20715    p50_us=1507   mean_us=1544   p99_us=2143    max_us=10435    barrier_p50_us=1343  barrier_p99_us=1983   p50/barrier=1.12 frames_in_flight_max=1 acks/fsync=32.0 frames=7814 parked=0 write_stall_p99_us=79 padding_pct=0.0 waits_fill=0 waits_group=26 round_target=32 4c/1c: p50=2.096 barrier=1.572
```
