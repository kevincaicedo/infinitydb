...
date: 1787716168 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.912–1.912 · client p50 2.039–2.039 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
| S35: always p50 over the barrier p50 at 32 conns | <= 1.3 x (client p50 / barrier p50; plan AC 1.2 + 0.1-window loop overhead — K = 1 reads ~1.85) | 1.84 | FAIL |
...
| S35: N-cell vs 1-cell always client p50 ratio (informational since 2026-08-22 — carries the pipeline's seal wait at K ≥ 2) | <= 1.3 x (N-cell p50 / 1-cell p50 at 32 conns, per-replicate median on the 0.4 % client histogram; FLUSH read 1.8, FUA K = 1 1.45, K = 3 1.25–1.38 on the 3 % instrument) | 2.04 | FAIL (informational) |
...
```
rep0 4c c32  ops/s=5741     p50_us=5055   mean_us=5561   p99_us=26303   max_us=38956    barrier_p50_us=2751  barrier_p99_us=19455  p50/barrier=1.84 frames_in_flight_max=1 acks/fsync=4.3 frames=47670 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=13
rep0 4c c256 ops/s=50606    p50_us=4959   mean_us=5054   p99_us=7423    max_us=113212   barrier_p50_us=2687  barrier_p99_us=8063   frames_in_flight_max=1 acks/fsync=36.3 frames=103181 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=111
rep0 4c read c64 P16 ops/s=1584821  p50_us=647    p99_us=1095    p999_us=1167    nils=734643
rep0 1c c32  ops/s=12426    p50_us=2479   mean_us=2574   p99_us=4047    max_us=13305    barrier_p50_us=1439  barrier_p99_us=2239   p50/barrier=1.72 frames_in_flight_max=1 acks/fsync=16.0 frames=9301 parked=0 write_stall_p99_us=91 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=1 4c/1c: p50=2.039 barrier=1.912
```
