...
date: 1787715495 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.964–1.964 · client p50 1.842–1.842 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
```
rep0 4c c32  ops/s=5171     p50_us=6127   mean_us=6183   p99_us=9983    max_us=16773    barrier_p50_us=3391  barrier_p99_us=6015   p50/barrier=1.81 frames_in_flight_max=1 acks/fsync=4.3 frames=42142 parked=0 write_stall_p99_us=927 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=12
rep0 4c c256 ops/s=44170    p50_us=6095   mean_us=5791   p99_us=8255    max_us=15775    barrier_p50_us=3263  barrier_p99_us=5503   frames_in_flight_max=1 acks/fsync=36.3 frames=84588 parked=0 write_stall_p99_us=911 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=117
rep0 4c read c64 P16 ops/s=1667083  p50_us=585    p99_us=961     p999_us=1043    nils=1193867
rep0 1c c32  ops/s=9544     p50_us=3327   mean_us=3351   p99_us=4671    max_us=12600    barrier_p50_us=1727  barrier_p99_us=2687   p50/barrier=1.93 frames_in_flight_max=1 acks/fsync=16.0 frames=10486 parked=0 write_stall_p99_us=91 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=3 4c/1c: p50=1.842 barrier=1.964
```
