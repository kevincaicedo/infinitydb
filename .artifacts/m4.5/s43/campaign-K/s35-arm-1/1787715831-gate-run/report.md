...
date: 1787715831 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 250 · device-probe off
env-check: OK
...
```
rep0 4c c32  ops/s=9523     p50_us=3207   mean_us=3358   p99_us=5823    max_us=15189    barrier_p50_us=2111  barrier_p99_us=3775   p50/barrier=1.52 frames_in_flight_max=1 acks/fsync=6.4 frames=49161 parked=0 write_stall_p99_us=623 padding_pct=0.0 waits_fill=0 waits_group=17637 round_target=18
rep0 4c c256 ops/s=68174    p50_us=3799   mean_us=3752   p99_us=6735    max_us=15006    barrier_p50_us=2367  barrier_p99_us=3775   frames_in_flight_max=1 acks/fsync=46.7 frames=100278 parked=0 write_stall_p99_us=279 padding_pct=0.0 waits_fill=0 waits_group=17426 round_target=82
rep0 4c read c64 P16 ops/s=1569926  p50_us=657    p99_us=1115    p999_us=1215    nils=259089
rep0 1c c32  ops/s=20745    p50_us=1507   mean_us=1541   p99_us=2143    max_us=12995    barrier_p50_us=1343  barrier_p99_us=1983   p50/barrier=1.12 frames_in_flight_max=1 acks/fsync=32.0 frames=7742 parked=0 write_stall_p99_us=85 padding_pct=0.0 waits_fill=0 waits_group=20 round_target=32 4c/1c: p50=2.128 barrier=1.572
```
