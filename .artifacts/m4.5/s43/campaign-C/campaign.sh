#!/usr/bin/env bash
# S43 campaign C (2026-08-25): the twice-corrected arm (ADR-0092 D1 second amendment — target measured at the barrier completion vs the uncovered count; the standalone path holds too), base (0) vs arm (250 µs),
...
ROOT=$HOME/bench-data/s43/campaign-C
