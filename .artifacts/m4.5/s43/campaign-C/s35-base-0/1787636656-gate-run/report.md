...
date: 1787636656 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.912–1.912 · client p50 1.981–1.981 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
| S35: N-cell vs 1-cell always client p50 ratio (informational since 2026-08-22 — carries the pipeline's seal wait at K ≥ 2) | <= 1.3 x (N-cell p50 / 1-cell p50 at 32 conns, per-replicate median on the 0.4 % client histogram; FLUSH read 1.8, FUA K = 1 1.45, K = 3 1.25–1.38 on the 3 % instrument) | 1.98 | FAIL (informational) |
...
```
rep0 4c c32  ops/s=6345     p50_us=4991   mean_us=5039   p99_us=8159    max_us=18318    barrier_p50_us=2751  barrier_p99_us=4735   p50/barrier=1.81 frames_in_flight_max=1 acks/fsync=4.3 frames=51267 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=17
rep0 4c c256 ops/s=53125    p50_us=4975   mean_us=4815   p99_us=7183    max_us=18024    barrier_p50_us=2751  barrier_p99_us=4479   frames_in_flight_max=1 acks/fsync=36.4 frames=104741 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=123
rep0 4c read c64 P16 ops/s=1673088  p50_us=603    p99_us=883     p999_us=955     nils=699893
rep0 1c c32  ops/s=12193    p50_us=2519   mean_us=2623   p99_us=3927    max_us=12981    barrier_p50_us=1439  barrier_p99_us=2239   p50/barrier=1.75 frames_in_flight_max=1 acks/fsync=16.0 frames=9171 parked=0 write_stall_p99_us=93 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=31 4c/1c: p50=1.981 barrier=1.912
```
