...
date: 1787637497 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 250 · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.647–1.647 · client p50 2.251–2.251 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
| S35: N-cell vs 1-cell always client p50 ratio (informational since 2026-08-22 — carries the pipeline's seal wait at K ≥ 2) | <= 1.3 x (N-cell p50 / 1-cell p50 at 32 conns, per-replicate median on the 0.4 % client histogram; FLUSH read 1.8, FUA K = 1 1.45, K = 3 1.25–1.38 on the 3 % instrument) | 2.25 | FAIL (informational) |
...
```
rep0 4c c32  ops/s=7853     p50_us=4023   mean_us=4072   p99_us=7039    max_us=15474    barrier_p50_us=2687  barrier_p99_us=4479   p50/barrier=1.50 frames_in_flight_max=1 acks/fsync=6.4 frames=40588 parked=0 write_stall_p99_us=895 padding_pct=0.0 waits_fill=0 waits_group=14587 round_target=21
rep0 4c c256 ops/s=54688    p50_us=4719   mean_us=4677   p99_us=8015    max_us=18617    barrier_p50_us=2943  barrier_p99_us=4351   frames_in_flight_max=1 acks/fsync=45.7 frames=81447 parked=0 write_stall_p99_us=463 padding_pct=0.0 waits_fill=0 waits_group=14391 round_target=84
rep0 4c read c64 P16 ops/s=1642198  p50_us=619    p99_us=1007    p999_us=1075    nils=589407
rep0 1c c32  ops/s=17505    p50_us=1787   mean_us=1827   p99_us=2439    max_us=12370    barrier_p50_us=1631  barrier_p99_us=2303   p50/barrier=1.10 frames_in_flight_max=1 acks/fsync=32.0 frames=6602 parked=0 write_stall_p99_us=87 padding_pct=0.0 waits_fill=0 waits_group=25 round_target=32 4c/1c: p50=2.251 barrier=1.647
```
