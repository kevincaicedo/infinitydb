...
date: 1787637329 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.556–1.556 · client p50 1.510–1.510 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
| S35: N-cell vs 1-cell barrier p50 ratio (device characterization — informational since the ADR-0087 fourth amendment, 2026-08-22) | <= 1.3 x (N-cell barrier p50 / 1-cell barrier p50 at 32 conns, per-replicate median; FLUSH read ~1.8, FUA read 1.35–1.54 at every K on 08-22 — qd4 vs qd1 on the device) | 1.56 | FAIL (informational) |
| S35: N-cell vs 1-cell always client p50 ratio (informational since 2026-08-22 — carries the pipeline's seal wait at K ≥ 2) | <= 1.3 x (N-cell p50 / 1-cell p50 at 32 conns, per-replicate median on the 0.4 % client histogram; FLUSH read 1.8, FUA K = 1 1.45, K = 3 1.25–1.38 on the 3 % instrument) | 1.51 | FAIL (informational) |
...
```
rep0 4c c32  ops/s=6403     p50_us=4927   mean_us=4994   p99_us=8287    max_us=19281    barrier_p50_us=2687  barrier_p99_us=4735   p50/barrier=1.83 frames_in_flight_max=1 acks/fsync=4.3 frames=52049 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=21
rep0 4c c256 ops/s=53537    p50_us=4975   mean_us=4778   p99_us=7295    max_us=15979    barrier_p50_us=2687  barrier_p99_us=4479   frames_in_flight_max=1 acks/fsync=36.4 frames=102173 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=116
rep0 4c read c64 P16 ops/s=1649646  p50_us=617    p99_us=957     p999_us=1043    nils=688793
rep0 1c c32  ops/s=9667     p50_us=3263   mean_us=3308   p99_us=4703    max_us=13535    barrier_p50_us=1727  barrier_p99_us=2687   p50/barrier=1.89 frames_in_flight_max=1 acks/fsync=16.0 frames=10369 parked=0 write_stall_p99_us=91 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=2 4c/1c: p50=1.510 barrier=1.556
```
