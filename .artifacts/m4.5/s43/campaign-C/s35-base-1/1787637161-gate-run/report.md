...
date: 1787637161 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.954–1.954 · client p50 1.771–1.771 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
```
rep0 4c c32  ops/s=6392     p50_us=4943   mean_us=5003   p99_us=8143    max_us=18384    barrier_p50_us=2687  barrier_p99_us=4863   p50/barrier=1.84 frames_in_flight_max=1 acks/fsync=4.3 frames=52126 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=21
rep0 4c c256 ops/s=53247    p50_us=4959   mean_us=4804   p99_us=7167    max_us=15949    barrier_p50_us=2687  barrier_p99_us=4479   frames_in_flight_max=1 acks/fsync=36.5 frames=103491 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=107
rep0 4c read c64 P16 ops/s=1646090  p50_us=617    p99_us=943     p999_us=1015    nils=678104
rep0 1c c32  ops/s=11076    p50_us=2791   mean_us=2887   p99_us=4159    max_us=14446    barrier_p50_us=1375  barrier_p99_us=2111   p50/barrier=2.03 frames_in_flight_max=1 acks/fsync=16.0 frames=8455 parked=0 write_stall_p99_us=79 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=19 4c/1c: p50=1.771 barrier=1.954
```
