...
date: 1787634862 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 · device-probe off
env-check: OK
...
```
rep0 4c c32  ops/s=6420     p50_us=4943   mean_us=4982   p99_us=8031    max_us=18365    barrier_p50_us=2751  barrier_p99_us=4607   p50/barrier=1.80 frames_in_flight_max=1 acks/fsync=4.3 frames=52422 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0
rep0 4c c256 ops/s=51981    p50_us=5039   mean_us=4921   p99_us=7231    max_us=18763    barrier_p50_us=2687  barrier_p99_us=4479   frames_in_flight_max=1 acks/fsync=35.5 frames=100263 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0
rep0 4c read c64 P16 ops/s=1654515  p50_us=597    p99_us=1005    p999_us=1095    nils=728433
rep0 1c c32  ops/s=12218    p50_us=2519   mean_us=2618   p99_us=4039    max_us=11869    barrier_p50_us=1439  barrier_p99_us=2303   p50/barrier=1.75 frames_in_flight_max=1 acks/fsync=16.0 frames=8793 parked=0 write_stall_p99_us=93 padding_pct=0.0 waits_fill=0 4c/1c: p50=1.962 barrier=1.912
```
