...
date: 1787634693 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.912–1.912 · client p50 1.956–1.956 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
```
rep0 4c c32  ops/s=6400     p50_us=4943   mean_us=4997   p99_us=8111    max_us=15331    barrier_p50_us=2751  barrier_p99_us=4735   p50/barrier=1.80 frames_in_flight_max=1 acks/fsync=4.3 frames=52550 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0
rep0 4c c256 ops/s=51456    p50_us=5119   mean_us=4971   p99_us=7247    max_us=15204    barrier_p50_us=2751  barrier_p99_us=4479   frames_in_flight_max=1 acks/fsync=35.3 frames=99744 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0
rep0 4c read c64 P16 ops/s=1670971  p50_us=607    p99_us=897     p999_us=1019    nils=767268
rep0 1c c32  ops/s=12168    p50_us=2527   mean_us=2628   p99_us=4063    max_us=15678    barrier_p50_us=1439  barrier_p99_us=2303   p50/barrier=1.76 frames_in_flight_max=1 acks/fsync=16.0 frames=9221 parked=0 write_stall_p99_us=91 padding_pct=0.0 waits_fill=0 4c/1c: p50=1.956 barrier=1.912
```
