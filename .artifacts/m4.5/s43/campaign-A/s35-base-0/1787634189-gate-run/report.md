...
date: 1787634189 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.955–1.955 · client p50 1.741–1.741 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
| S35: N-cell vs 1-cell always client p50 ratio (informational since 2026-08-22 — carries the pipeline's seal wait at K ≥ 2) | <= 1.3 x (N-cell p50 / 1-cell p50 at 32 conns, per-replicate median on the 0.4 % client histogram; FLUSH read 1.8, FUA K = 1 1.45, K = 3 1.25–1.38 on the 3 % instrument) | 1.74 | FAIL (informational) |
...
```
rep0 4c c32  ops/s=6375     p50_us=4943   mean_us=5016   p99_us=8159    max_us=17085    barrier_p50_us=2751  barrier_p99_us=4607   p50/barrier=1.80 frames_in_flight_max=1 acks/fsync=4.3 frames=51657 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0
rep0 4c c256 ops/s=51930    p50_us=5071   mean_us=4925   p99_us=7247    max_us=15002    barrier_p50_us=2687  barrier_p99_us=4479   frames_in_flight_max=1 acks/fsync=35.3 frames=103166 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0
rep0 4c read c64 P16 ops/s=1669043  p50_us=615    p99_us=917     p999_us=989     nils=761451
rep0 1c c32  ops/s=11019    p50_us=2839   mean_us=2902   p99_us=4087    max_us=12246    barrier_p50_us=1407  barrier_p99_us=2111   p50/barrier=2.02 frames_in_flight_max=1 acks/fsync=16.0 frames=12405 parked=0 write_stall_p99_us=79 padding_pct=0.0 waits_fill=0 4c/1c: p50=1.741 barrier=1.955
```
