...
date: 1787634525 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 250 · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 2.262–2.262 · client p50 2.412–2.412 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
| S35: N-cell vs 1-cell barrier p50 ratio (device characterization — informational since the ADR-0087 fourth amendment, 2026-08-22) | <= 1.3 x (N-cell barrier p50 / 1-cell barrier p50 at 32 conns, per-replicate median; FLUSH read ~1.8, FUA read 1.35–1.54 at every K on 08-22 — qd4 vs qd1 on the device) | 2.26 | FAIL (informational) |
| S35: N-cell vs 1-cell always client p50 ratio (informational since 2026-08-22 — carries the pipeline's seal wait at K ≥ 2) | <= 1.3 x (N-cell p50 / 1-cell p50 at 32 conns, per-replicate median on the 0.4 % client histogram; FLUSH read 1.8, FUA K = 1 1.45, K = 3 1.25–1.38 on the 3 % instrument) | 2.41 | FAIL (informational) |
...
```
rep0 4c c32  ops/s=5172     p50_us=6095   mean_us=6183   p99_us=9887    max_us=13947    barrier_p50_us=3327  barrier_p99_us=5887   p50/barrier=1.83 frames_in_flight_max=1 acks/fsync=4.3 frames=41851 parked=0 write_stall_p99_us=927 padding_pct=0.0 waits_fill=0
rep0 4c c256 ops/s=42943    p50_us=6191   mean_us=5956   p99_us=8383    max_us=16217    barrier_p50_us=3263  barrier_p99_us=5503   frames_in_flight_max=1 acks/fsync=35.3 frames=82491 parked=0 write_stall_p99_us=911 padding_pct=0.0 waits_fill=0
rep0 4c read c64 P16 ops/s=1681915  p50_us=593    p99_us=957     p999_us=1031    nils=1314780
rep0 1c c32  ops/s=12163    p50_us=2527   mean_us=2629   p99_us=4071    max_us=12067    barrier_p50_us=1471  barrier_p99_us=2303   p50/barrier=1.72 frames_in_flight_max=1 acks/fsync=16.0 frames=9208 parked=0 write_stall_p99_us=91 padding_pct=0.0 waits_fill=0 4c/1c: p50=2.412 barrier=2.262
```
