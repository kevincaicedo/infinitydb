...
date: 1787635030 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 250 · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.955–1.955 · client p50 1.756–1.756 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
| S35: N-cell vs 1-cell always client p50 ratio (informational since 2026-08-22 — carries the pipeline's seal wait at K ≥ 2) | <= 1.3 x (N-cell p50 / 1-cell p50 at 32 conns, per-replicate median on the 0.4 % client histogram; FLUSH read 1.8, FUA K = 1 1.45, K = 3 1.25–1.38 on the 3 % instrument) | 1.76 | FAIL (informational) |
...
```
rep0 4c c32  ops/s=6394     p50_us=4943   mean_us=5001   p99_us=8063    max_us=15754    barrier_p50_us=2751  barrier_p99_us=4607   p50/barrier=1.80 frames_in_flight_max=1 acks/fsync=4.3 frames=51931 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0
rep0 4c c256 ops/s=53359    p50_us=4959   mean_us=4794   p99_us=7199    max_us=16630    barrier_p50_us=2687  barrier_p99_us=4479   frames_in_flight_max=1 acks/fsync=36.5 frames=99853 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0
rep0 4c read c64 P16 ops/s=1673627  p50_us=609    p99_us=841     p999_us=941     nils=695887
rep0 1c c32  ops/s=11063    p50_us=2815   mean_us=2891   p99_us=4095    max_us=13676    barrier_p50_us=1407  barrier_p99_us=2111   p50/barrier=2.00 frames_in_flight_max=1 acks/fsync=16.0 frames=12519 parked=0 write_stall_p99_us=83 padding_pct=0.0 waits_fill=0 4c/1c: p50=1.756 barrier=1.955
```
