#!/usr/bin/env bash
# S43 campaign B (2026-08-25): the corrected arm (ADR-0092 D1 amended — round target = population at completion), base (0) vs arm (250 µs),
...
ROOT=$HOME/bench-data/s43/campaign-B
