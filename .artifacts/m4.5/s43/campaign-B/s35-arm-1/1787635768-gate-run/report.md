...
date: 1787635768 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 250 · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.867–1.867 · client p50 1.962–1.962 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
| S35: N-cell vs 1-cell barrier p50 ratio (device characterization — informational since the ADR-0087 fourth amendment, 2026-08-22) | <= 1.3 x (N-cell barrier p50 / 1-cell barrier p50 at 32 conns, per-replicate median; FLUSH read ~1.8, FUA read 1.35–1.54 at every K on 08-22 — qd4 vs qd1 on the device) | 1.87 | FAIL (informational) |
| S35: N-cell vs 1-cell always client p50 ratio (informational since 2026-08-22 — carries the pipeline's seal wait at K ≥ 2) | <= 1.3 x (N-cell p50 / 1-cell p50 at 32 conns, per-replicate median on the 0.4 % client histogram; FLUSH read 1.8, FUA K = 1 1.45, K = 3 1.25–1.38 on the 3 % instrument) | 1.96 | FAIL (informational) |
...
```
rep0 4c c32  ops/s=6364     p50_us=4927   mean_us=5024   p99_us=8223    max_us=17718    barrier_p50_us=2687  barrier_p99_us=4735   p50/barrier=1.83 frames_in_flight_max=1 acks/fsync=4.3 frames=51700 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=197 round_target=7
rep0 4c c256 ops/s=53245    p50_us=4959   mean_us=4804   p99_us=7151    max_us=15623    barrier_p50_us=2687  barrier_p99_us=4479   frames_in_flight_max=1 acks/fsync=36.6 frames=105698 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=5 round_target=19
rep0 4c read c64 P16 ops/s=1642638  p50_us=633    p99_us=1023    p999_us=1111    nils=674440
rep0 1c c32  ops/s=12227    p50_us=2511   mean_us=2616   p99_us=4031    max_us=12024    barrier_p50_us=1439  barrier_p99_us=2239   p50/barrier=1.74 frames_in_flight_max=1 acks/fsync=16.0 frames=9237 parked=0 write_stall_p99_us=91 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=1 4c/1c: p50=1.962 barrier=1.867
```
