...
date: 1787635937 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 0 · device-probe off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.912–1.912 · client p50 1.962–1.962 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
```
rep0 4c c32  ops/s=6386     p50_us=4943   mean_us=5007   p99_us=8127    max_us=16131    barrier_p50_us=2751  barrier_p99_us=4735   p50/barrier=1.80 frames_in_flight_max=1 acks/fsync=4.3 frames=52110 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=4
rep0 4c c256 ops/s=53526    p50_us=4959   mean_us=4779   p99_us=7151    max_us=17907    barrier_p50_us=2687  barrier_p99_us=4479   frames_in_flight_max=1 acks/fsync=36.4 frames=102302 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=23
rep0 4c read c64 P16 ops/s=1662913  p50_us=555    p99_us=1099    p999_us=1171    nils=688498
rep0 1c c32  ops/s=12264    p50_us=2519   mean_us=2607   p99_us=4047    max_us=12828    barrier_p50_us=1439  barrier_p99_us=2239   p50/barrier=1.75 frames_in_flight_max=1 acks/fsync=16.0 frames=9245 parked=0 write_stall_p99_us=91 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=1 4c/1c: p50=1.962 barrier=1.912
```
