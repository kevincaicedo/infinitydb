...
date: 1787635600 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight auto (fua 3 / flush 1) · barrier-class flush · staging-mib 4 · device-write-mbps probe-file · seal-pace off · flush-group-window-us 250 · device-probe off
env-check: OK
...
```
rep0 4c c32  ops/s=6418     p50_us=4927   mean_us=4982   p99_us=8159    max_us=17321    barrier_p50_us=2751  barrier_p99_us=4735   p50/barrier=1.79 frames_in_flight_max=1 acks/fsync=4.3 frames=51784 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=184 round_target=5
rep0 4c c256 ops/s=52487    p50_us=5023   mean_us=4873   p99_us=7167    max_us=18233    barrier_p50_us=2687  barrier_p99_us=4479   frames_in_flight_max=1 acks/fsync=35.8 frames=103142 parked=0 write_stall_p99_us=639 padding_pct=0.0 waits_fill=0 waits_group=2 round_target=12
rep0 4c read c64 P16 ops/s=1651027  p50_us=629    p99_us=885     p999_us=979     nils=707492
rep0 1c c32  ops/s=11885    p50_us=2615   mean_us=2690   p99_us=4071    max_us=12601    barrier_p50_us=1439  barrier_p99_us=2303   p50/barrier=1.82 frames_in_flight_max=1 acks/fsync=16.0 frames=11612 parked=0 write_stall_p99_us=89 padding_pct=0.0 waits_fill=0 waits_group=0 round_target=1 4c/1c: p50=1.884 barrier=1.912
```
