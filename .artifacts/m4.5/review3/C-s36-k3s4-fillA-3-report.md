...
date: 1787417628 (unix) · binary target/release/infinityd · cells 4 · S36 row only · frames-in-flight 3 · barrier-class fua · staging-mib 4 · device-write-mbps probe-file · seal-pace off
env-check: OK
...
| S36: server CPU across the pure-write everysec leg | >= 300 % of one core (400 = four cells flat out; pre-S36 read 123–185) | 263.85 | FAIL |
...
| S36: everysec max latency at the comparator-matched offered rate (S27 D5) | <= 50 ms (ADR-0081 D5 bar at an offered rate; latency from the intended send instant) | 2.53 | PASS |
...
```
device closed-loop c32 everysec ops/s=300353   p99_us=142     max_us=372747   server_cpu_pct=264   parked=2338 write_stall_p99_us=1535
device arm: io_budget_model=probed ckpts_completed=28 write_amp_milli_log_checkpoint=1355 (undefined=0) checkpoint_over_log_milli=178 log_padding_pct=12.1 log_frame_bytes=8307920896 ckpt_bytes_total=1472974848 zero_fill_bytes=0 ckpt_interval_bytes(max)=268435456 deferrals[zero_fill=0 tier_flush=0 checkpoint=162456] frame_waits_pace=0
device offered-rate c32 P16 target=100000 everysec achieved ops/s=99997    p99_us=91      max_us=2534     server_cpu_pct=394   parked=0
tmpfs control (tmpfs) closed-loop c32 everysec ops/s=467640   p99_us=148     max_us=11512    server_cpu_pct=402  
```
