...
date: 1787412378 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight 3 · barrier-class fua · staging-mib 2 · device-write-mbps probe-file · seal-pace off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.435–1.435 · client p50 1.395–1.395 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
```
rep0 4c c32  ops/s=36876    p50_us=727    mean_us=866    p99_us=1951    max_us=107297   barrier_p50_us=607   barrier_p99_us=1471   p50/barrier=1.20 frames_in_flight_max=3 acks/fsync=2.2 frames=175199 parked=0 write_stall_p99_us=1535 padding_pct=51.6 waits_fill=0
rep0 4c c256 ops/s=165223   p50_us=1155   mean_us=1548   p99_us=15295   max_us=66613    barrier_p50_us=655   barrier_p99_us=2175   frames_in_flight_max=3 acks/fsync=14.9 frames=136469 parked=0 write_stall_p99_us=2175 padding_pct=12.3 waits_fill=0
rep0 4c read c64 P16 ops/s=1587326  p50_us=605    p99_us=1103    p999_us=1207    nils=180
rep0 1c c32  ops/s=58870    p50_us=521    mean_us=543    p99_us=1271    max_us=9736     barrier_p50_us=423   barrier_p99_us=1279   p50/barrier=1.23 frames_in_flight_max=3 acks/fsync=24.6 frames=25756 parked=0 write_stall_p99_us=1279 padding_pct=9.7 waits_fill=0 4c/1c: p50=1.395 barrier=1.435
```
