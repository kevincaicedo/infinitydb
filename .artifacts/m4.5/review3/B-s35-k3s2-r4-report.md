...
date: 1787414227 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight 3 · barrier-class fua · staging-mib 2 · device-write-mbps probe-file · seal-pace off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.346–1.346 · client p50 1.395–1.395 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
```
rep0 4c c32  ops/s=38805    p50_us=741    mean_us=823    p99_us=1927    max_us=11939    barrier_p50_us=623   barrier_p99_us=1439   p50/barrier=1.19 frames_in_flight_max=3 acks/fsync=2.2 frames=182734 parked=0 write_stall_p99_us=1631 padding_pct=51.4 waits_fill=0
rep0 4c c256 ops/s=122855   p50_us=1179   mean_us=2082   p99_us=24191   max_us=147992   barrier_p50_us=655   barrier_p99_us=3583   frames_in_flight_max=3 acks/fsync=14.9 frames=108404 parked=0 write_stall_p99_us=3391 padding_pct=12.3 waits_fill=0
rep0 4c read c64 P16 ops/s=1627416  p50_us=679    p99_us=893     p999_us=961     nils=2431
rep0 1c c32  ops/s=55125    p50_us=531    mean_us=580    p99_us=1275    max_us=10081    barrier_p50_us=463   barrier_p99_us=1279   p50/barrier=1.15 frames_in_flight_max=3 acks/fsync=23.5 frames=26296 parked=0 write_stall_p99_us=1503 padding_pct=9.4 waits_fill=0 4c/1c: p50=1.395 barrier=1.346
```
