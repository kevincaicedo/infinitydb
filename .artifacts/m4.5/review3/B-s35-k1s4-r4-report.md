...
date: 1787414563 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight 1 · barrier-class fua · staging-mib 4 · device-write-mbps probe-file · seal-pace off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.543–1.543 · client p50 1.431–1.431 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
| S35: N-cell vs 1-cell always client p50 ratio (informational since 2026-08-22 — carries the pipeline's seal wait at K ≥ 2) | <= 1.3 x (N-cell p50 / 1-cell p50 at 32 conns, per-replicate median on the 0.4 % client histogram; FLUSH read 1.8, FUA K = 1 1.45, K = 3 1.25–1.38 on the 3 % instrument) | 1.43 | FAIL (informational) |
...
```
rep0 4c c32  ops/s=28444    p50_us=1083   mean_us=1124   p99_us=2543    max_us=12188    barrier_p50_us=591   barrier_p99_us=1343   p50/barrier=1.83 frames_in_flight_max=1 acks/fsync=4.3 frames=72265 parked=0 write_stall_p99_us=1759 padding_pct=35.6 waits_fill=0
rep0 4c c256 ops/s=149671   p50_us=1355   mean_us=1709   p99_us=13119   max_us=51862    barrier_p50_us=655   barrier_p99_us=1823   frames_in_flight_max=1 acks/fsync=33.7 frames=55489 parked=0 write_stall_p99_us=1951 padding_pct=5.0 waits_fill=0
rep0 4c read c64 P16 ops/s=1610840  p50_us=595    p99_us=969     p999_us=1047    nils=1340
rep0 1c c32  ops/s=40327    p50_us=757    mean_us=793    p99_us=1427    max_us=11922    barrier_p50_us=383   barrier_p99_us=767    p50/barrier=1.98 frames_in_flight_max=1 acks/fsync=16.1 frames=27464 parked=0 write_stall_p99_us=1407 padding_pct=9.0 waits_fill=0 4c/1c: p50=1.431 barrier=1.543
```
