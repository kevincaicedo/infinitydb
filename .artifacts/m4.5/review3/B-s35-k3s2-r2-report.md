...
date: 1787413555 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight 3 · barrier-class fua · staging-mib 2 · device-write-mbps probe-file · seal-pace off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.311–1.311 · client p50 1.418–1.418 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
| S35: N-cell vs 1-cell always client p50 ratio (informational since 2026-08-22 — carries the pipeline's seal wait at K ≥ 2) | <= 1.3 x (N-cell p50 / 1-cell p50 at 32 conns, per-replicate median on the 0.4 % client histogram; FLUSH read 1.8, FUA K = 1 1.45, K = 3 1.25–1.38 on the 3 % instrument) | 1.42 | FAIL (informational) |
...
```
rep0 4c c32  ops/s=39071    p50_us=733    mean_us=818    p99_us=1931    max_us=12515    barrier_p50_us=607   barrier_p99_us=1439   p50/barrier=1.21 frames_in_flight_max=3 acks/fsync=2.2 frames=184282 parked=0 write_stall_p99_us=1503 padding_pct=51.5 waits_fill=0
rep0 4c c256 ops/s=161776   p50_us=1147   mean_us=1581   p99_us=15711   max_us=76299    barrier_p50_us=655   barrier_p99_us=2047   frames_in_flight_max=3 acks/fsync=14.9 frames=133453 parked=0 write_stall_p99_us=2111 padding_pct=12.3 waits_fill=0
rep0 4c read c64 P16 ops/s=1576819  p50_us=657    p99_us=1091    p999_us=1171    nils=330
rep0 1c c32  ops/s=57194    p50_us=517    mean_us=559    p99_us=1275    max_us=9991     barrier_p50_us=463   barrier_p99_us=1279   p50/barrier=1.12 frames_in_flight_max=3 acks/fsync=23.1 frames=26930 parked=0 write_stall_p99_us=1279 padding_pct=9.8 waits_fill=0 4c/1c: p50=1.418 barrier=1.311
```
