...
date: 1787413218 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight 3 · barrier-class fua · staging-mib 4 · device-write-mbps probe-file · seal-pace off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.435–1.435 · client p50 1.468–1.468 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
```
rep0 4c c32  ops/s=39077    p50_us=737    mean_us=817    p99_us=1935    max_us=13198    barrier_p50_us=607   barrier_p99_us=1471   p50/barrier=1.21 frames_in_flight_max=3 acks/fsync=2.2 frames=187228 parked=0 write_stall_p99_us=1503 padding_pct=51.6 waits_fill=0
rep0 4c c256 ops/s=158263   p50_us=1159   mean_us=1616   p99_us=17535   max_us=49301    barrier_p50_us=671   barrier_p99_us=2175   frames_in_flight_max=3 acks/fsync=14.9 frames=132204 parked=0 write_stall_p99_us=2175 padding_pct=12.3 waits_fill=0
rep0 4c read c64 P16 ops/s=1631391  p50_us=605    p99_us=933     p999_us=1007    nils=448
rep0 1c c32  ops/s=58289    p50_us=502    mean_us=548    p99_us=1271    max_us=10328    barrier_p50_us=423   barrier_p99_us=1279   p50/barrier=1.19 frames_in_flight_max=3 acks/fsync=24.8 frames=25473 parked=0 write_stall_p99_us=1279 padding_pct=9.5 waits_fill=0 4c/1c: p50=1.468 barrier=1.435
```
