...
date: 1787412546 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight 3 · barrier-class fua · staging-mib 4 · device-write-mbps probe-file · seal-pace off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.511–1.511 · client p50 1.408–1.408 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
| S35: always p50 over the barrier p50 at 32 conns | <= 1.3 x (client p50 / barrier p50; plan AC 1.2 + 0.1-window loop overhead — K = 1 reads ~1.85) | 1.16 | PASS |
| S35: N-cell vs 1-cell barrier p50 ratio (S34's F2 contention term) | <= 1.3 x (N-cell barrier p50 / 1-cell barrier p50 at 32 conns, per-replicate median; FLUSH read ~1.8, FUA K = 3 read 1.09–1.15 on 08-22) | 1.51 | FAIL |
| S35: N-cell vs 1-cell always client p50 ratio (informational since 2026-08-22 — carries the pipeline's seal wait at K ≥ 2) | <= 1.3 x (N-cell p50 / 1-cell p50 at 32 conns, per-replicate median on the 0.4 % client histogram; FLUSH read 1.8, FUA K = 1 1.45, K = 3 1.25–1.38 on the 3 % instrument) | 1.41 | FAIL (informational) |
...
```
rep0 4c c32  ops/s=38817    p50_us=739    mean_us=823    p99_us=1939    max_us=11205    barrier_p50_us=639   barrier_p99_us=1439   p50/barrier=1.16 frames_in_flight_max=3 acks/fsync=2.2 frames=184458 parked=0 write_stall_p99_us=1535 padding_pct=51.6 waits_fill=0
rep0 4c c256 ops/s=155853   p50_us=1143   mean_us=1641   p99_us=17919   max_us=136022   barrier_p50_us=671   barrier_p99_us=2111   frames_in_flight_max=3 acks/fsync=14.9 frames=130568 parked=0 write_stall_p99_us=2111 padding_pct=12.3 waits_fill=0
rep0 4c read c64 P16 ops/s=1576501  p50_us=541    p99_us=1203    p999_us=1343    nils=412
rep0 1c c32  ops/s=57771    p50_us=525    mean_us=553    p99_us=1275    max_us=9788     barrier_p50_us=423   barrier_p99_us=1279   p50/barrier=1.24 frames_in_flight_max=3 acks/fsync=24.6 frames=26248 parked=0 write_stall_p99_us=1407 padding_pct=9.4 waits_fill=0 4c/1c: p50=1.408 barrier=1.511
```
