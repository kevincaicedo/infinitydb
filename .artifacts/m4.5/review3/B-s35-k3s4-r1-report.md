...
date: 1787412882 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight 3 · barrier-class fua · staging-mib 4 · device-write-mbps probe-file · seal-pace off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.435–1.435 · client p50 1.391–1.391 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
```
rep0 4c c32  ops/s=39092    p50_us=733    mean_us=817    p99_us=1931    max_us=18270    barrier_p50_us=607   barrier_p99_us=1439   p50/barrier=1.21 frames_in_flight_max=3 acks/fsync=2.2 frames=185734 parked=0 write_stall_p99_us=1535 padding_pct=51.6 waits_fill=0
rep0 4c c256 ops/s=106660   p50_us=1187   mean_us=2398   p99_us=26559   max_us=87480    barrier_p50_us=655   barrier_p99_us=9727   frames_in_flight_max=3 acks/fsync=14.9 frames=97002 parked=0 write_stall_p99_us=9471 padding_pct=12.3 waits_fill=0
rep0 4c read c64 P16 ops/s=1644519  p50_us=607    p99_us=833     p999_us=949     nils=4035
rep0 1c c32  ops/s=57046    p50_us=527    mean_us=560    p99_us=1271    max_us=11464    barrier_p50_us=423   barrier_p99_us=1279   p50/barrier=1.25 frames_in_flight_max=3 acks/fsync=24.2 frames=25673 parked=0 write_stall_p99_us=1279 padding_pct=9.7 waits_fill=0 4c/1c: p50=1.391 barrier=1.435
```
