...
date: 1787413050 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight 1 · barrier-class fua · staging-mib 4 · device-write-mbps probe-file · seal-pace off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.543–1.543 · client p50 1.446–1.446 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
```
rep0 4c c32  ops/s=27425    p50_us=1095   mean_us=1165   p99_us=3927    max_us=11642    barrier_p50_us=591   barrier_p99_us=1343   p50/barrier=1.85 frames_in_flight_max=1 acks/fsync=4.3 frames=69606 parked=0 write_stall_p99_us=1567 padding_pct=35.8 waits_fill=0
rep0 4c c256 ops/s=132338   p50_us=1323   mean_us=1932   p99_us=19711   max_us=220259   barrier_p50_us=655   barrier_p99_us=1951   frames_in_flight_max=1 acks/fsync=33.9 frames=49946 parked=0 write_stall_p99_us=2015 padding_pct=5.0 waits_fill=0
rep0 4c read c64 P16 ops/s=1589560  p50_us=671    p99_us=989     p999_us=1063    nils=3023
rep0 1c c32  ops/s=40586    p50_us=757    mean_us=787    p99_us=1427    max_us=12182    barrier_p50_us=383   barrier_p99_us=767    p50/barrier=1.98 frames_in_flight_max=1 acks/fsync=16.2 frames=27337 parked=0 write_stall_p99_us=1151 padding_pct=9.0 waits_fill=0 4c/1c: p50=1.446 barrier=1.543
```
