...
date: 1787414395 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight 3 · barrier-class fua · staging-mib 4 · device-write-mbps probe-file · seal-pace off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.311–1.311 · client p50 1.406–1.406 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
| S35: always p50 over the barrier p50 at 32 conns | <= 1.3 x (client p50 / barrier p50; plan AC 1.2 + 0.1-window loop overhead — K = 1 reads ~1.85) | 1.22 | PASS |
| S35: N-cell vs 1-cell barrier p50 ratio (S34's F2 contention term) | <= 1.3 x (N-cell barrier p50 / 1-cell barrier p50 at 32 conns, per-replicate median; FLUSH read ~1.8, FUA K = 3 read 1.09–1.15 on 08-22) | 1.31 | FAIL |
...
```
rep0 4c c32  ops/s=36614    p50_us=741    mean_us=873    p99_us=1947    max_us=108358   barrier_p50_us=607   barrier_p99_us=1471   p50/barrier=1.22 frames_in_flight_max=3 acks/fsync=2.2 frames=173411 parked=0 write_stall_p99_us=1663 padding_pct=51.7 waits_fill=0
rep0 4c c256 ops/s=111425   p50_us=1191   mean_us=2295   p99_us=25407   max_us=88393    barrier_p50_us=655   barrier_p99_us=9983   frames_in_flight_max=3 acks/fsync=14.9 frames=101146 parked=0 write_stall_p99_us=9471 padding_pct=12.3 waits_fill=0
rep0 4c read c64 P16 ops/s=1613632  p50_us=629    p99_us=911     p999_us=979     nils=4106
rep0 1c c32  ops/s=56539    p50_us=527    mean_us=565    p99_us=1271    max_us=9883     barrier_p50_us=463   barrier_p99_us=1279   p50/barrier=1.14 frames_in_flight_max=3 acks/fsync=23.4 frames=26693 parked=0 write_stall_p99_us=1503 padding_pct=9.6 waits_fill=0 4c/1c: p50=1.406 barrier=1.311
```
