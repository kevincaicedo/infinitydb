...
date: 1787412209 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight 1 · barrier-class fua · staging-mib 4 · device-write-mbps probe-file · seal-pace off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.543–1.543 · client p50 1.538–1.538 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
| S35: always p50 over the barrier p50 at 32 conns | <= 1.3 x (client p50 / barrier p50; plan AC 1.2 + 0.1-window loop overhead — K = 1 reads ~1.85) | 1.87 | FAIL |
...
| S35: N-cell vs 1-cell always client p50 ratio (informational since 2026-08-22 — carries the pipeline's seal wait at K ≥ 2) | <= 1.3 x (N-cell p50 / 1-cell p50 at 32 conns, per-replicate median on the 0.4 % client histogram; FLUSH read 1.8, FUA K = 1 1.45, K = 3 1.25–1.38 on the 3 % instrument) | 1.54 | FAIL (informational) |
...
```
rep0 4c c32  ops/s=28182    p50_us=1103   mean_us=1134   p99_us=2543    max_us=14530    barrier_p50_us=591   barrier_p99_us=1375   p50/barrier=1.87 frames_in_flight_max=1 acks/fsync=4.3 frames=72177 parked=0 write_stall_p99_us=1567 padding_pct=35.6 waits_fill=0
rep0 4c c256 ops/s=151458   p50_us=1331   mean_us=1688   p99_us=11775   max_us=239577   barrier_p50_us=655   barrier_p99_us=1791   frames_in_flight_max=1 acks/fsync=33.7 frames=56008 parked=0 write_stall_p99_us=1855 padding_pct=5.0 waits_fill=0
rep0 4c read c64 P16 ops/s=1609342  p50_us=669    p99_us=949     p999_us=1043    nils=1365
rep0 1c c32  ops/s=42886    p50_us=717    mean_us=745    p99_us=1419    max_us=12774    barrier_p50_us=383   barrier_p99_us=767    p50/barrier=1.87 frames_in_flight_max=1 acks/fsync=17.6 frames=26701 parked=0 write_stall_p99_us=1151 padding_pct=9.0 waits_fill=0 4c/1c: p50=1.538 barrier=1.543
```
