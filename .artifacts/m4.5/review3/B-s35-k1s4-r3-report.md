...
date: 1787413723 (unix) · binary target/release/infinityd · cells 4 · 1 replicates · S35 row only · frames-in-flight 1 · barrier-class fua · staging-mib 4 · device-write-mbps probe-file · seal-pace off
env-check: OK
...
- s35 4c/1c per-replicate ratios (median of 1; spread): barrier 1.543–1.543 · client p50 1.497–1.497 — client histogram 256 sub-buckets/octave (≈ 0.4 %, 2 µs at 512–1024 µs); the barrier p50 is the server's 32-sub-bucket histogram (≈ 3 %, 16 µs at that octave)
...
```
rep0 4c c32  ops/s=26929    p50_us=1091   mean_us=1172   p99_us=2543    max_us=304343   barrier_p50_us=591   barrier_p99_us=1343   p50/barrier=1.85 frames_in_flight_max=1 acks/fsync=4.3 frames=69114 parked=0 write_stall_p99_us=1631 padding_pct=35.7 waits_fill=0
rep0 4c c256 ops/s=139296   p50_us=1375   mean_us=1836   p99_us=17343   max_us=103828   barrier_p50_us=655   barrier_p99_us=1855   frames_in_flight_max=1 acks/fsync=33.9 frames=52428 parked=0 write_stall_p99_us=1951 padding_pct=5.0 waits_fill=0
rep0 4c read c64 P16 ops/s=1621960  p50_us=615    p99_us=929     p999_us=1001    nils=1895
rep0 1c c32  ops/s=41499    p50_us=729    mean_us=770    p99_us=1423    max_us=11554    barrier_p50_us=383   barrier_p99_us=767    p50/barrier=1.90 frames_in_flight_max=1 acks/fsync=16.7 frames=27066 parked=0 write_stall_p99_us=1151 padding_pct=9.0 waits_fill=0 4c/1c: p50=1.497 barrier=1.543
```
