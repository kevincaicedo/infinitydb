...
date: 1787372438 (unix) · binary target/release/infinityd · cells 4 · 3 replicates · S35 row only · frames-in-flight 3 · barrier-class fua · staging-mib 2 · device-write-mbps probe-file · seal-pace off
env-check: OK
...
```
rep0 4c c32  ops/s=37686    p50_us=751    p99_us=2239    max_us=11551    barrier_p50_us=623   barrier_p99_us=1471   p50/barrier=1.21 frames_in_flight_max=3 acks/fsync=2.2 frames=175441 parked=0 write_stall_p99_us=1567 padding_pct=51.3 waits_fill=2122
rep0 4c c256 ops/s=151430   p50_us=1183   p99_us=18431   max_us=77248    barrier_p50_us=671   barrier_p99_us=2303   frames_in_flight_max=3 acks/fsync=14.9 frames=128169 parked=0 write_stall_p99_us=2367 padding_pct=12.4 waits_fill=3
rep0 4c read c64 P16 ops/s=1606743  p50_us=607    p99_us=959     p999_us=1055    nils=531
rep0 1c c32  ops/s=52123    p50_us=575    p99_us=1311    max_us=10040    barrier_p50_us=559   barrier_p99_us=1279   p50/barrier=1.03 frames_in_flight_max=3 acks/fsync=19.0 frames=30713 parked=0 write_stall_p99_us=1503 padding_pct=10.6 waits_fill=5
rep1 4c c32  ops/s=37133    p50_us=751    p99_us=2687    max_us=12346    barrier_p50_us=607   barrier_p99_us=1471   p50/barrier=1.24 frames_in_flight_max=3 acks/fsync=2.2 frames=173688 parked=0 write_stall_p99_us=1535 padding_pct=51.2 waits_fill=3501
rep1 4c c256 ops/s=113038   p50_us=1215   p99_us=25599   max_us=54503    barrier_p50_us=655   barrier_p99_us=9471   frames_in_flight_max=3 acks/fsync=14.8 frames=102482 parked=0 write_stall_p99_us=8959 padding_pct=12.4 waits_fill=1
rep1 4c read c64 P16 ops/s=1598416  p50_us=639    p99_us=1055    p999_us=1119    nils=4022
rep1 1c c32  ops/s=52630    p50_us=575    p99_us=1311    max_us=9872     barrier_p50_us=559   barrier_p99_us=1279   p50/barrier=1.03 frames_in_flight_max=3 acks/fsync=18.0 frames=33353 parked=0 write_stall_p99_us=1279 padding_pct=11.1 waits_fill=17
rep2 4c c32  ops/s=36934    p50_us=735    p99_us=4479    max_us=12914    barrier_p50_us=607   barrier_p99_us=1471   p50/barrier=1.21 frames_in_flight_max=3 acks/fsync=2.3 frames=169208 parked=0 write_stall_p99_us=1599 padding_pct=51.0 waits_fill=3547
rep2 4c c256 ops/s=134245   p50_us=1215   p99_us=24575   max_us=109407   barrier_p50_us=655   barrier_p99_us=2751   frames_in_flight_max=3 acks/fsync=14.8 frames=116272 parked=0 write_stall_p99_us=2751 padding_pct=12.4 waits_fill=3
rep2 4c read c64 P16 ops/s=1626086  p50_us=543    p99_us=1055    p999_us=1151    nils=1924
rep2 1c c32  ops/s=52419    p50_us=575    p99_us=1343    max_us=10112    barrier_p50_us=559   barrier_p99_us=1279   p50/barrier=1.03 frames_in_flight_max=3 acks/fsync=18.9 frames=30937 parked=0 write_stall_p99_us=1503 padding_pct=10.7 waits_fill=22
```
