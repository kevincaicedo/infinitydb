...
date: 1787371934 (unix) · binary target/release/infinityd · cells 4 · 3 replicates · S35 row only · frames-in-flight 3 · barrier-class fua · staging-mib 2 · device-write-mbps probe-file · seal-pace off
env-check: OK
...
```
rep0 4c c32  ops/s=39129    p50_us=735    p99_us=1951    max_us=11989    barrier_p50_us=607   barrier_p99_us=1471   p50/barrier=1.21 frames_in_flight_max=3 acks/fsync=2.2 frames=185269 parked=0 write_stall_p99_us=1663 padding_pct=51.6 waits_fill=0
rep0 4c c256 ops/s=131405   p50_us=1183   p99_us=24063   max_us=83119    barrier_p50_us=655   barrier_p99_us=3007   frames_in_flight_max=3 acks/fsync=14.8 frames=113853 parked=0 write_stall_p99_us=2943 padding_pct=12.4 waits_fill=0
rep0 4c read c64 P16 ops/s=1607560  p50_us=607    p99_us=975     p999_us=1055    nils=1551
rep0 1c c32  ops/s=52991    p50_us=575    p99_us=1311    max_us=10846    barrier_p50_us=559   barrier_p99_us=1279   p50/barrier=1.03 frames_in_flight_max=3 acks/fsync=19.1 frames=31454 parked=0 write_stall_p99_us=1311 padding_pct=10.9 waits_fill=0
rep1 4c c32  ops/s=38955    p50_us=751    p99_us=1951    max_us=14521    barrier_p50_us=607   barrier_p99_us=1471   p50/barrier=1.24 frames_in_flight_max=3 acks/fsync=2.2 frames=184313 parked=0 write_stall_p99_us=1695 padding_pct=51.7 waits_fill=0
rep1 4c c256 ops/s=18786    p50_us=1535   p99_us=77823   max_us=339278   barrier_p50_us=639   barrier_p99_us=23551  frames_in_flight_max=3 acks/fsync=14.7 frames=22071 parked=0 write_stall_p99_us=23551 padding_pct=12.5 waits_fill=0
rep1 4c read c64 P16 ops/s=1632592  p50_us=607    p99_us=991     p999_us=1119    nils=538947
rep1 1c c32  ops/s=53582    p50_us=543    p99_us=1311    max_us=11118    barrier_p50_us=543   barrier_p99_us=1279   p50/barrier=1.00 frames_in_flight_max=3 acks/fsync=20.0 frames=29096 parked=0 write_stall_p99_us=1311 padding_pct=10.3 waits_fill=0
rep2 4c c32  ops/s=38884    p50_us=751    p99_us=1951    max_us=12762    barrier_p50_us=623   barrier_p99_us=1471   p50/barrier=1.21 frames_in_flight_max=3 acks/fsync=2.2 frames=185758 parked=0 write_stall_p99_us=1535 padding_pct=51.7 waits_fill=0
rep2 4c c256 ops/s=145095   p50_us=1183   p99_us=23039   max_us=61127    barrier_p50_us=655   barrier_p99_us=2303   frames_in_flight_max=3 acks/fsync=14.8 frames=123566 parked=0 write_stall_p99_us=2303 padding_pct=12.4 waits_fill=0
rep2 4c read c64 P16 ops/s=1576321  p50_us=751    p99_us=1055    p999_us=1151    nils=748
rep2 1c c32  ops/s=53964    p50_us=543    p99_us=1311    max_us=9963     barrier_p50_us=543   barrier_p99_us=1311   p50/barrier=1.00 frames_in_flight_max=3 acks/fsync=21.1 frames=27955 parked=0 write_stall_p99_us=1343 padding_pct=10.0 waits_fill=0
```
