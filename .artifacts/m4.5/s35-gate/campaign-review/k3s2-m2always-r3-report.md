...
date: 1787361096 (unix) · cells: 4 · duration: 10s · ONLY-ALWAYS (A/B leg; frames-in-flight 3 · barrier-class fua · staging-mib 2 · device-write-mbps probe-file · seal-pace off)
env-check: OK
...
- always row: 5734368 gated acks / 154386 fsyncs = ratio 37.1; fsync latency p50/p99/p999 = 671/1919/23551 us (HDR ~3% quantization); log_writes_per_iter 0.027 (154525 frames / 5681152 iterations); group formation p50/p99 = 32/115 records vs ~256 available in-flight writes/cell = 0.12x (M2.5-S07 gate: >= 0.8x)
...
| always grouped writes | >= 300000 w/s | 572149.86 | PASS |
...
| acks/fsync grouping ratio above floor | >= 2 acks per fsync | 37.14 | PASS (informational) |
