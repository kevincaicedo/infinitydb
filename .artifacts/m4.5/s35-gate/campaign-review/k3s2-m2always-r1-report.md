...
date: 1787360994 (unix) · cells: 4 · duration: 10s · ONLY-ALWAYS (A/B leg; frames-in-flight 3 · barrier-class fua · staging-mib 2 · device-write-mbps probe-file · seal-pace off)
env-check: OK
...
- always row: 6837785 gated acks / 182929 fsyncs = ratio 37.4; fsync latency p50/p99/p999 = 639/1663/3839 us (HDR ~3% quantization); log_writes_per_iter 0.028 (183064 frames / 6638592 iterations); group formation p50/p99 = 32/111 records vs ~256 available in-flight writes/cell = 0.12x (M2.5-S07 gate: >= 0.8x)
...
| always grouped writes | >= 300000 w/s | 634775.52 | PASS |
...
| acks/fsync grouping ratio above floor | >= 2 acks per fsync | 37.38 | PASS (informational) |
