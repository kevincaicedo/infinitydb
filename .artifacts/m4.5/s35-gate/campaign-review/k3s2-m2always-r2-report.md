...
date: 1787361045 (unix) · cells: 4 · duration: 10s · ONLY-ALWAYS (A/B leg; frames-in-flight 3 · barrier-class fua · staging-mib 2 · device-write-mbps probe-file · seal-pace off)
env-check: OK
...
- always row: 5958236 gated acks / 161262 fsyncs = ratio 36.9; fsync latency p50/p99/p999 = 655/1983/24575 us (HDR ~3% quantization); log_writes_per_iter 0.028 (161380 frames / 5862400 iterations); group formation p50/p99 = 32/115 records vs ~256 available in-flight writes/cell = 0.12x (M2.5-S07 gate: >= 0.8x)
...
| always grouped writes | >= 300000 w/s | 541119.15 | PASS |
...
| acks/fsync grouping ratio above floor | >= 2 acks per fsync | 36.95 | PASS (informational) |
