...
date: 1787336975 (unix) · cells: 4 · duration: 10s · ONLY-ALWAYS (A/B leg; frames-in-flight 4 · barrier-class fua · staging-mib 4)
env-check: OK
...
- always row: 6645562 gated acks / 218658 fsyncs = ratio 30.4; fsync latency p50/p99/p999 = 655/1823/5887 us (HDR ~3% quantization); log_writes_per_iter 0.039 (218764 frames / 5590016 iterations); group formation p50/p99 = 26/101 records vs ~256 available in-flight writes/cell = 0.10x (M2.5-S07 gate: >= 0.8x)
...
| always grouped writes | >= 300000 w/s | 613038.03 | PASS |
...
| acks/fsync grouping ratio above floor | >= 2 acks per fsync | 30.39 | PASS (informational) |
