...
date: 1787337026 (unix) · cells: 4 · duration: 10s · ONLY-ALWAYS (A/B leg; frames-in-flight 1 · barrier-class fua · staging-mib 4)
env-check: OK
...
- always row: 4033104 gated acks / 44474 fsyncs = ratio 90.7; fsync latency p50/p99/p999 = 655/18943/30207 us (HDR ~3% quantization); log_writes_per_iter 0.008 (44612 frames / 5266432 iterations); group formation p50/p99 = 93/135 records vs ~256 available in-flight writes/cell = 0.36x (M2.5-S07 gate: >= 0.8x)
...
| always grouped writes | >= 300000 w/s | 376223.32 | PASS |
...
| One log write per iteration | <= 1 writes/iter | 0.01 | PASS |
| acks/fsync grouping ratio above floor | >= 2 acks per fsync | 90.68 | PASS (informational) |
