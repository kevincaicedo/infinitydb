...
|---|---|---|---:|---|
| infinitydb | host | infinityd 53cd74c (git 53cd74cef82e-dirty, x86_64-unknown-linux-gnu) | 162.6 | `target/release/infinityd --port 7000 --cells 8` |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|
| infinitydb | mixed | 1 | 1054635 | 0.379 | 0.327 | 0.871 | 1.007 | 162.6 |
| dragonfly | mixed | 1 | 1016531 | 0.393 | 0.359 | 0.847 | 1.223 | 36.4 |
