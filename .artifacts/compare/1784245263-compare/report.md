...
|---|---|---|---:|---|
| infinitydb | host | infinityd 8391a38 (git 8391a38fb3b6-dirty, x86_64-unknown-linux-gnu) | 162.9 | `target/release/infinityd --port 7000 --cells 8` |
...
|---|---|---:|---:|---:|---:|---:|---:|---:|
| infinitydb | mixed | 1 | 1023847 | 0.390 | 0.343 | 0.855 | 1.015 | 162.9 |
| dragonfly | mixed | 1 | 1023445 | 0.390 | 0.351 | 0.855 | 1.791 | 36.6 |
