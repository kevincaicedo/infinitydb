...
| dragonfly | host | dragonfly v1.39.0-699862e5da7cb29bf5642a1da422c4c78cefae38 | 60.4 | `dragonfly --port 7001 --proactor_threads 12 --cache_mode --dbfilename '' --logtostderr --dir /tmp` |

## Results — memtier_benchmark

| Engine | Workload | Pipe | Throughput (ops/s) | avg (ms) | p50 (ms) | p99 (ms) | p99.9 (ms) | RSS (MiB) |
|---|---|---:|---:|---:|---:|---:|---:|---:|
| infinitydb | mixed | 1 | 1115281 | 0.537 | 0.583 | 0.967 | 3.631 | 254.2 |
| dragonfly | mixed | 1 | 1112646 | 0.539 | 0.519 | 2.543 | 4.079 | 44.9 |
