...
|---|---|---|---:|---|
| infinitydb | host | infinityd 8391a38 (git 8391a38fb3b6-dirty, x86_64-unknown-linux-gnu) | 255.0 | `target/release/infinityd --port 7000 --cells 12` |
| dragonfly | host | dragonfly v1.39.0-699862e5da7cb29bf5642a1da422c4c78cefae38 | 60.6 | `dragonfly --port 7001 --proactor_threads 12 --cache_mode --dbfilename '' --logtostderr --dir /tmp` |

## Results — memtier_benchmark

| Engine | Workload | Pipe | Throughput (ops/s) | avg (ms) | p50 (ms) | p99 (ms) | p99.9 (ms) | RSS (MiB) |
|---|---|---:|---:|---:|---:|---:|---:|---:|
| infinitydb | mixed | 1 | 1231373 | 0.487 | 0.471 | 1.223 | 3.967 | 255.0 |
| dragonfly | mixed | 1 | 1131876 | 0.529 | 0.447 | 2.959 | 4.447 | 44.6 |
