...
date: 1786159323 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
nils = 0
ops_per_sec = 16908
combined_client p50_us = 2431 · p99_us = 28671 · p999_us = 163839 · max_us = 1980834
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0xe54114cc3749b99e
...
tiering_cold_resolves = 764645702
...
nils = 0
ops_per_sec = 16824
combined_client p50_us = 2623 · p99_us = 28671 · p999_us = 102399 · max_us = 1724568
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0x592983d44cf60b1c
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 774288852
tripwire sqes/submit = 7.7
```
