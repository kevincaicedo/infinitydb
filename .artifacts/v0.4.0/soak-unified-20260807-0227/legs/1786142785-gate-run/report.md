...
date: 1786142785 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +54.1%) — absolutes understate the server; deltas remain valid at fixed generator config
...
nils = 0
ops_per_sec = 15548
combined_client p50_us = 2623 · p99_us = 31743 · p999_us = 192511 · max_us = 2347690
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.20%
stream_checksum = 0xfb59c8ae7e108c5c
...
tiering_cold_resolves = 591667868
...
nils = 0
ops_per_sec = 16458
combined_client p50_us = 2687 · p99_us = 29183 · p999_us = 110591 · max_us = 2292591
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0x786306dfea50860d
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 601144618
tripwire sqes/submit = 7.7
```
