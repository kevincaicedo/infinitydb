...
date: 1786166841 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +43.6%) — absolutes understate the server; deltas remain valid at fixed generator config
...
nils = 0
ops_per_sec = 17308
combined_client p50_us = 2495 · p99_us = 27647 · p999_us = 114687 · max_us = 2014713
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0x47a39f1022703374
...
tiering_cold_resolves = 843869384
...
nils = 0
ops_per_sec = 18844
combined_client p50_us = 2431 · p99_us = 25087 · p999_us = 86015 · max_us = 972301
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0xc3641f6954961ba1
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 853494942
tripwire sqes/submit = 7.6
```
