...
date: 1786168344 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +8.8%) — absolutes understate the server; deltas remain valid at fixed generator config
...
nils = 0
ops_per_sec = 18675
combined_client p50_us = 2367 · p99_us = 24575 · p999_us = 98303 · max_us = 1742327
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0xf254772ce32adedc
...
tiering_cold_resolves = 860301712
...
nils = 0
ops_per_sec = 15586
combined_client p50_us = 2751 · p99_us = 31743 · p999_us = 129023 · max_us = 1472089
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0x0015b73d244d8c72
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 869228125
tripwire sqes/submit = 7.6
```
