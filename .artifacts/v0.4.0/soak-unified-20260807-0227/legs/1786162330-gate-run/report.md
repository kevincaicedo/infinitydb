...
date: 1786162330 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +78.6%) — absolutes understate the server; deltas remain valid at fixed generator config
...
nils = 0
ops_per_sec = 15302
combined_client p50_us = 2623 · p99_us = 31743 · p999_us = 172031 · max_us = 3042470
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0x2f16fdded5e47345
...
tiering_cold_resolves = 795799835
...
nils = 0
ops_per_sec = 16827
combined_client p50_us = 2559 · p99_us = 29183 · p999_us = 112639 · max_us = 2213280
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0xd988b5512289d8f6
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 806199407
tripwire sqes/submit = 7.7
```
