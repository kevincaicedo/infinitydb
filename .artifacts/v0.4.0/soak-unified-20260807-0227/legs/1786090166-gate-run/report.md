...
date: 1786090166 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +8.0%) — absolutes understate the server; deltas remain valid at fixed generator config
...
| Write amplification, worst tiered namespace | < 3 x user bytes (wal + flush) | 1.59 | PASS |
...
|---|---|
| ycsb-a-zipfian | 1.585× worst of 4 namespace(s) · blob: n/a (no blob activity) |
...
nils = 0
ops_per_sec = 18972
combined_client p50_us = 2303 · p99_us = 24575 · p999_us = 106495 · max_us = 1673415
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0x8b5953c4119204c1
...
tiering_cold_resolves = 52974216
...
nils = 0
ops_per_sec = 13241
combined_client p50_us = 3263 · p99_us = 36863 · p999_us = 147455 · max_us = 2010625
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0xefb8a533597ca544
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 60934984
tripwire sqes/submit = 7.7
```
