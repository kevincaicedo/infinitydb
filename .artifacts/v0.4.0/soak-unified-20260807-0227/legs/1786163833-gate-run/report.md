...
date: 1786163833 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +48.8%) — absolutes understate the server; deltas remain valid at fixed generator config
...
nils = 0
ops_per_sec = 15488
combined_client p50_us = 2687 · p99_us = 30207 · p999_us = 180223 · max_us = 1779901
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0x15da1904d4efaf76
...
tiering_cold_resolves = 812276659
...
nils = 0
ops_per_sec = 14370
combined_client p50_us = 3071 · p99_us = 33791 · p999_us = 100351 · max_us = 3476665
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0x935fc49d1faf8b72
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 820840273
tripwire sqes/submit = 7.6
```
