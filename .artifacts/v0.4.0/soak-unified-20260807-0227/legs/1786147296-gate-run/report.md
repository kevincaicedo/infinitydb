...
date: 1786147296 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +46.6%) — absolutes understate the server; deltas remain valid at fixed generator config
...
nils = 0
ops_per_sec = 15710
combined_client p50_us = 2751 · p99_us = 30207 · p999_us = 143359 · max_us = 1549666
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.23%
stream_checksum = 0x57e93dfd5a9ccc87
...
tiering_cold_resolves = 640455739
...
nils = 0
ops_per_sec = 17118
combined_client p50_us = 2559 · p99_us = 28671 · p999_us = 110591 · max_us = 1956151
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0xc131488548d531a2
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 650253222
tripwire sqes/submit = 7.7
```
