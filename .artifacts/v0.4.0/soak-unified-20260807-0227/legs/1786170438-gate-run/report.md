...
date: 1786170438 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 235s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
nils = 0
ops_per_sec = 19135
combined_client p50_us = 2303 · p99_us = 25087 · p999_us = 79871 · max_us = 657540
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.20%
stream_checksum = 0x027b22034914a3df
...
tiering_cold_resolves = 885307044
...
nils = 0
ops_per_sec = 19324
combined_client p50_us = 2111 · p99_us = 27135 · p999_us = 124927 · max_us = 1213555
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.18%
stream_checksum = 0x7f846fe1325c687f
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 888469785
tripwire sqes/submit = 7.6
```
