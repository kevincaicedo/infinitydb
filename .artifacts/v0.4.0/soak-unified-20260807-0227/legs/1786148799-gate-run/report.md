...
date: 1786148799 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
nils = 0
ops_per_sec = 15838
combined_client p50_us = 2687 · p99_us = 30719 · p999_us = 147455 · max_us = 1041195
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0xb2fa044e7b8d6eda
...
tiering_cold_resolves = 656508935
...
nils = 0
ops_per_sec = 17210
combined_client p50_us = 2559 · p99_us = 28671 · p999_us = 100351 · max_us = 1008815
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0xd5c268c869700f90
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 665161244
tripwire sqes/submit = 7.7
```
