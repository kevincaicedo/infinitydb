...
date: 1786133764 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
nils = 0
ops_per_sec = 17727
combined_client p50_us = 2367 · p99_us = 26623 · p999_us = 116735 · max_us = 1662957
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0xd92e7a31a04d7070
...
tiering_cold_resolves = 498690573
...
nils = 0
ops_per_sec = 16298
combined_client p50_us = 2559 · p99_us = 30719 · p999_us = 147455 · max_us = 2149830
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0xe8eb5e23d7511edc
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 507665692
tripwire sqes/submit = 7.7
```
