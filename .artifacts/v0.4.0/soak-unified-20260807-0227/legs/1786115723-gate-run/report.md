...
date: 1786115723 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
|---|---|
| ycsb-a-zipfian | 1.543× worst of 4 namespace(s) · blob: n/a (no blob activity) |
...
nils = 0
ops_per_sec = 19232
combined_client p50_us = 2239 · p99_us = 24575 · p999_us = 98303 · max_us = 1754367
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0x1188267cdbac67cf
...
tiering_cold_resolves = 309550574
...
nils = 0
ops_per_sec = 20511
combined_client p50_us = 2111 · p99_us = 23551 · p999_us = 96255 · max_us = 1416201
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0x195c83ce6e89abb6
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 318131596
tripwire sqes/submit = 7.7
```
