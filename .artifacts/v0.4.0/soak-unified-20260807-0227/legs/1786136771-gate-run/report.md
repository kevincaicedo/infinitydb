...
date: 1786136771 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +6.8%) — absolutes understate the server; deltas remain valid at fixed generator config
...
nils = 0
ops_per_sec = 18911
combined_client p50_us = 2239 · p99_us = 25599 · p999_us = 126975 · max_us = 2264598
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0x51beaf52472bb929
...
tiering_cold_resolves = 529255275
...
nils = 0
ops_per_sec = 15612
combined_client p50_us = 2815 · p99_us = 30719 · p999_us = 118783 · max_us = 1698910
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0x5e7267a270255555
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 538656289
tripwire sqes/submit = 7.7
```
