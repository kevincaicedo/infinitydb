...
date: 1786153309 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
| Cold reads: p99 < 1.5 ms on NVMe under loaded zipfian rows | < 1.5 ms, cold-read split histogram, worst loaded row | 12.80 | FAIL (DEV-TIER, non-binding) |
...
| ycsb-b-zipfian | 1.540× worst of 4 namespace(s) · blob: n/a (no blob activity) |
...
nils = 0
ops_per_sec = 16083
combined_client p50_us = 2623 · p99_us = 29695 · p999_us = 126975 · max_us = 2134433
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0x9b69ba55e9400d64
...
nils = 0
ops_per_sec = 19521
combined_client p50_us = 2239 · p99_us = 24575 · p999_us = 104447 · max_us = 2959386
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0x16bdf014ebbf09bc
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 712789210
tripwire sqes/submit = 7.7
```
