...
date: 1786169847 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +25.8%) — absolutes understate the server; deltas remain valid at fixed generator config
...
nils = 0
ops_per_sec = 14775
combined_client p50_us = 2815 · p99_us = 32767 · p999_us = 159743 · max_us = 1439481
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.20%
stream_checksum = 0xbf356d727dd538ff
...
tiering_cold_resolves = 874850599
...
nils = 0
ops_per_sec = 18084
combined_client p50_us = 2303 · p99_us = 27135 · p999_us = 122879 · max_us = 1558862
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0x1484e2012c6c2260
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 882974195
tripwire sqes/submit = 7.6
```
