...
date: 1786114220 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +52.8%) — absolutes understate the server; deltas remain valid at fixed generator config
...
nils = 0
ops_per_sec = 15314
combined_client p50_us = 2751 · p99_us = 31231 · p999_us = 159743 · max_us = 2264939
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.20%
stream_checksum = 0x9664708811138769
...
tiering_cold_resolves = 293800976
...
nils = 0
ops_per_sec = 14645
combined_client p50_us = 2943 · p99_us = 33791 · p999_us = 151551 · max_us = 2017092
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.20%
stream_checksum = 0x7a81216d0e877ac7
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 302399342
tripwire sqes/submit = 7.7
```
