...
date: 1786138275 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
nils = 0
ops_per_sec = 18235
combined_client p50_us = 2367 · p99_us = 25599 · p999_us = 122879 · max_us = 1886168
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0xe35e403dfd53502e
...
tiering_cold_resolves = 544809831
...
nils = 0
ops_per_sec = 15547
combined_client p50_us = 2815 · p99_us = 31743 · p999_us = 114687 · max_us = 1812267
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0x2aa7a83a96bf522f
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 554030937
tripwire sqes/submit = 7.7
```
