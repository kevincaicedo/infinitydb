...
date: 1786150303 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
nils = 0
ops_per_sec = 16463
combined_client p50_us = 2559 · p99_us = 28671 · p999_us = 135167 · max_us = 2224950
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0x7d31cbb804b132ea
...
tiering_cold_resolves = 671311089
...
nils = 0
ops_per_sec = 14132
combined_client p50_us = 3007 · p99_us = 34815 · p999_us = 147455 · max_us = 1459879
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0xf05937c1a4137d68
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 680336525
tripwire sqes/submit = 7.7
```
