...
date: 1786135267 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
nils = 0
ops_per_sec = 16285
combined_client p50_us = 2687 · p99_us = 28159 · p999_us = 114687 · max_us = 1666069
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0x87804c469a14a652
...
tiering_cold_resolves = 513538841
...
nils = 0
ops_per_sec = 17057
combined_client p50_us = 2559 · p99_us = 29183 · p999_us = 135167 · max_us = 1053956
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0xd0b1c2f057bc367f
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 522796943
tripwire sqes/submit = 7.7
```
