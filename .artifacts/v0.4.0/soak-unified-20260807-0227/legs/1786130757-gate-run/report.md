...
date: 1786130757 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +10.4%) — absolutes understate the server; deltas remain valid at fixed generator config
...
nils = 0
ops_per_sec = 16783
combined_client p50_us = 2559 · p99_us = 27135 · p999_us = 135167 · max_us = 2019882
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0x88ba382952d5c0e2
...
tiering_cold_resolves = 468917835
...
nils = 0
ops_per_sec = 15592
combined_client p50_us = 2687 · p99_us = 31743 · p999_us = 176127 · max_us = 2873848
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0xfb589c346a1caee9
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 477138383
tripwire sqes/submit = 7.7
```
