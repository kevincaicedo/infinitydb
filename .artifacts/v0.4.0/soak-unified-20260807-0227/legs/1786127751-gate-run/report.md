...
date: 1786127751 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +33.1%) — absolutes understate the server; deltas remain valid at fixed generator config
...
nils = 0
ops_per_sec = 18818
combined_client p50_us = 2239 · p99_us = 24575 · p999_us = 151551 · max_us = 1058438
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0x2f1606085c311ebb
...
tiering_cold_resolves = 436855291
...
nils = 0
ops_per_sec = 14806
combined_client p50_us = 2879 · p99_us = 33791 · p999_us = 135167 · max_us = 1559283
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0x59116e32f971237b
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 446552942
tripwire sqes/submit = 7.7
```
