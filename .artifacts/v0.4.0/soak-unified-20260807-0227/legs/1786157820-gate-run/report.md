...
date: 1786157820 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +18.3%) — absolutes understate the server; deltas remain valid at fixed generator config
...
nils = 0
ops_per_sec = 19786
combined_client p50_us = 2111 · p99_us = 25087 · p999_us = 110591 · max_us = 1636133
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0xa2b7ed966529231e
...
tiering_cold_resolves = 748987493
...
nils = 0
ops_per_sec = 14425
combined_client p50_us = 2879 · p99_us = 34815 · p999_us = 151551 · max_us = 2360370
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0x9ebd2b94422603ae
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 758520293
tripwire sqes/submit = 7.7
```
