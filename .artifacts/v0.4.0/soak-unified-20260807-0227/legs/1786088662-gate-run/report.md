...
date: 1786088662 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +47.8%) — absolutes understate the server; deltas remain valid at fixed generator config
...
| Cold reads: p99 < 1.5 ms on NVMe under loaded zipfian rows | < 1.5 ms, cold-read split histogram, worst loaded row | 14.85 | FAIL (DEV-TIER, non-binding) |
...
| ycsb-b-zipfian | 1.565× worst of 4 namespace(s) · blob: n/a (no blob activity) |
...
nils = 0
ops_per_sec = 16337
combined_client p50_us = 2559 · p99_us = 29695 · p999_us = 196607 · max_us = 1434143
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0x3f91f4ab9f9e9fb8
...
tiering_cold_resolves = 36339118
...
nils = 0
ops_per_sec = 20229
combined_client p50_us = 2239 · p99_us = 23551 · p999_us = 81919 · max_us = 1931666
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0x6fb1fc0080dfe362
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
tiering_cold_p99_us (worst cell) = 14335
tiering_cold_p999_us (worst cell) = 57343
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 45624761
tripwire sqes/submit = 7.7
```
