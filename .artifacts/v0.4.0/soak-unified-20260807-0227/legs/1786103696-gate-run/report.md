...
date: 1786103696 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s -6.1%) — absolutes understate the server; deltas remain valid at fixed generator config
...
nils = 0
ops_per_sec = 21981
combined_client p50_us = 2015 · p99_us = 21503 · p999_us = 79871 · max_us = 1719964
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0x7a41232bf8aab39c
...
tiering_cold_resolves = 188932312
...
nils = 0
ops_per_sec = 14793
combined_client p50_us = 2687 · p99_us = 33791 · p999_us = 192511 · max_us = 2755016
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0xb14a5ade829c42b4
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 198213554
tripwire sqes/submit = 7.7
```
