...
date: 1786151806 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +19.9%) — absolutes understate the server; deltas remain valid at fixed generator config
...
nils = 0
ops_per_sec = 20234
combined_client p50_us = 2239 · p99_us = 24063 · p999_us = 79871 · max_us = 735588
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0xfc84b9f4ec996820
...
tiering_cold_resolves = 687858844
...
nils = 0
ops_per_sec = 15957
combined_client p50_us = 2751 · p99_us = 30207 · p999_us = 120831 · max_us = 1312867
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0x8a590a8af738f076
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 696799971
tripwire sqes/submit = 7.7
```
