...
date: 1786170536 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 38s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +12.4%) — absolutes understate the server; deltas remain valid at fixed generator config
...
nils = 0
ops_per_sec = 25847
combined_client p50_us = 1663 · p99_us = 18431 · p999_us = 49151 · max_us = 253342
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0x1d723e3d500399b3
...
tiering_cold_resolves = 888806006
tripwire sqes/submit = 7.6
```
...
nils = 0
ops_per_sec = 31749
combined_client p50_us = 1311 · p99_us = 17407 · p999_us = 39935 · max_us = 643417
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.24%
stream_checksum = 0xb69a9c00e9868211
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 889261344
tripwire sqes/submit = 7.6
```
