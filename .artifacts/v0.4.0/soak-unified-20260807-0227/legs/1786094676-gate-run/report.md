...
date: 1786094676 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +42.9%) — absolutes understate the server; deltas remain valid at fixed generator config
...
| Write amplification, worst tiered namespace | < 3 x user bytes (wal + flush) | 1.55 | PASS |
...
| Cold reads: p99 < 1.5 ms on NVMe under loaded zipfian rows | < 1.5 ms, cold-read split histogram, worst loaded row | 13.57 | FAIL (DEV-TIER, non-binding) |
...
|---|---|
| ycsb-a-zipfian | 1.549× worst of 4 namespace(s) · blob: n/a (no blob activity) |
| ycsb-b-zipfian | 1.555× worst of 4 namespace(s) · blob: n/a (no blob activity) |
...
nils = 0
ops_per_sec = 15640
combined_client p50_us = 2815 · p99_us = 29695 · p999_us = 112639 · max_us = 1522032
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.20%
stream_checksum = 0xbb19801780593b8e
...
nils = 0
ops_per_sec = 14736
combined_client p50_us = 2623 · p99_us = 35839 · p999_us = 217087 · max_us = 3202540
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0x27b2f83cd8d25dcd
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1087
tiering_cold_p99_us (worst cell) = 13567
tiering_cold_p999_us (worst cell) = 51199
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 105663215
tripwire sqes/submit = 7.8
```
