...
date: 1786144289 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
nils = 0
ops_per_sec = 17729
combined_client p50_us = 2367 · p99_us = 26623 · p999_us = 143359 · max_us = 1435639
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0x9b97cca5ff70a15b
...
tiering_cold_resolves = 607971374
...
nils = 0
ops_per_sec = 16477
combined_client p50_us = 2623 · p99_us = 29695 · p999_us = 114687 · max_us = 1940705
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0x8aaefd69275612e8
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 618096560
tripwire sqes/submit = 7.7
```
