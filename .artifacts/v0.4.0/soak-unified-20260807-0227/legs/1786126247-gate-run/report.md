...
date: 1786126247 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +34.2%) — absolutes understate the server; deltas remain valid at fixed generator config
...
nils = 0
ops_per_sec = 15314
combined_client p50_us = 2751 · p99_us = 30207 · p999_us = 172031 · max_us = 1927588
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0xb0e19cccbc36624c
...
tiering_cold_resolves = 421130108
...
nils = 0
ops_per_sec = 15049
combined_client p50_us = 2943 · p99_us = 31231 · p999_us = 114687 · max_us = 1293097
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0xd7d190d79279b4bc
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 429662671
tripwire sqes/submit = 7.7
```
