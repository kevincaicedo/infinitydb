...
date: 1786105199 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): generator unsaturated at 8 conns (+50% conns moved ops/s -4.5%)
...
| ycsb-b-zipfian | 1.538× worst of 4 namespace(s) · blob: n/a (no blob activity) |
...
nils = 0
ops_per_sec = 18181
combined_client p50_us = 2303 · p99_us = 26111 · p999_us = 120831 · max_us = 2110991
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0x04cb3188ded35ece
...
tiering_cold_resolves = 204615959
...
nils = 0
ops_per_sec = 18239
combined_client p50_us = 2431 · p99_us = 26623 · p999_us = 104447 · max_us = 1561659
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0x8343d229286146f0
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 212845914
tripwire sqes/submit = 7.7
```
