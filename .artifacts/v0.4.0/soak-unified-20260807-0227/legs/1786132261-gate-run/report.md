...
date: 1786132261 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +60.9%) — absolutes understate the server; deltas remain valid at fixed generator config
...
nils = 0
ops_per_sec = 15537
combined_client p50_us = 2687 · p99_us = 32255 · p999_us = 163839 · max_us = 1762100
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0x49b9a3be254c629b
...
tiering_cold_resolves = 483389599
...
nils = 0
ops_per_sec = 17812
combined_client p50_us = 2367 · p99_us = 28159 · p999_us = 102399 · max_us = 1834713
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0x39e0aac37f9cce68
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 492291860
tripwire sqes/submit = 7.7
```
