...
date: 1786160826 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +40.0%) — absolutes understate the server; deltas remain valid at fixed generator config
...
nils = 0
ops_per_sec = 16679
combined_client p50_us = 2559 · p99_us = 27647 · p999_us = 163839 · max_us = 1674421
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0x077af652be5889a3
...
tiering_cold_resolves = 780609701
...
nils = 0
ops_per_sec = 14686
combined_client p50_us = 2943 · p99_us = 33791 · p999_us = 126975 · max_us = 1173832
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0xcf987a7550286ed9
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 789843145
tripwire sqes/submit = 7.7
```
