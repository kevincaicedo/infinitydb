...
date: 1786120233 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
nils = 0
ops_per_sec = 21591
combined_client p50_us = 1983 · p99_us = 22527 · p999_us = 75775 · max_us = 2021308
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0xfbebf6f47e4976c1
...
tiering_cold_resolves = 357398749
...
nils = 0
ops_per_sec = 12531
combined_client p50_us = 3455 · p99_us = 37887 · p999_us = 151551 · max_us = 1472794
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.20%
stream_checksum = 0x1390937e034547d2
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 366743297
tripwire sqes/submit = 7.7
```
