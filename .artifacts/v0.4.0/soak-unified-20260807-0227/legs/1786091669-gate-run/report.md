...
date: 1786091669 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +61.6%) — absolutes understate the server; deltas remain valid at fixed generator config
...
| Cold reads: p99 < 1.5 ms on NVMe under loaded zipfian rows | < 1.5 ms, cold-read split histogram, worst loaded row | 13.82 | FAIL (DEV-TIER, non-binding) |
...
|---|---|
| ycsb-a-zipfian | 1.579× worst of 4 namespace(s) · blob: n/a (no blob activity) |
| ycsb-b-zipfian | 1.557× worst of 4 namespace(s) · blob: n/a (no blob activity) |
...
nils = 0
ops_per_sec = 15268
combined_client p50_us = 2687 · p99_us = 30207 · p999_us = 204799 · max_us = 1859257
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.20%
stream_checksum = 0xbb1d499515b9de17
...
tiering_cold_p99_us (worst cell) = 13823
tiering_cold_p999_us (worst cell) = 54271
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 65827266
tripwire sqes/submit = 7.8
```
...
nils = 0
ops_per_sec = 22672
combined_client p50_us = 1983 · p99_us = 22527 · p999_us = 67583 · max_us = 847237
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0xb7baa829ef49c15a
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1087
tiering_cold_p99_us (worst cell) = 13567
tiering_cold_p999_us (worst cell) = 52223
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 75323991
tripwire sqes/submit = 7.8
```
