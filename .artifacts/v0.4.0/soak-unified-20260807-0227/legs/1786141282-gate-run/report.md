...
date: 1786141282 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +45.4%) — absolutes understate the server; deltas remain valid at fixed generator config
...
nils = 0
ops_per_sec = 16227
combined_client p50_us = 2559 · p99_us = 29183 · p999_us = 167935 · max_us = 1507574
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0x12e8c6f9e0cd55b1
...
tiering_cold_resolves = 575526342
...
nils = 0
ops_per_sec = 17184
combined_client p50_us = 2623 · p99_us = 27647 · p999_us = 106495 · max_us = 1846920
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0x930ea1533b98ac80
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 585615709
tripwire sqes/submit = 7.7
```
