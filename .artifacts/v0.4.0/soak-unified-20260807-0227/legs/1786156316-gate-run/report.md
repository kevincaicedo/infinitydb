...
date: 1786156316 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +13.1%) — absolutes understate the server; deltas remain valid at fixed generator config
...
nils = 0
ops_per_sec = 18173
combined_client p50_us = 2367 · p99_us = 26623 · p999_us = 129023 · max_us = 1457615
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0x649be6ab700ea387
...
tiering_cold_resolves = 733211942
...
nils = 0
ops_per_sec = 15967
combined_client p50_us = 2687 · p99_us = 30719 · p999_us = 147455 · max_us = 1881210
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.20%
stream_checksum = 0x726cebabf91f77e2
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
...
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 742384000
tripwire sqes/submit = 7.7
```
