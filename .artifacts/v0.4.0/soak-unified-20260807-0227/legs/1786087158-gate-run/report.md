...
date: 1786087158 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
| Write amplification, worst tiered namespace | < 3 x user bytes (wal + flush) | 1.62 | PASS |
...
| Cold reads: p99 < 1.5 ms on NVMe under loaded zipfian rows | < 1.5 ms, cold-read split histogram, worst loaded row | 15.62 | FAIL (DEV-TIER, non-binding) |
...
|---|---|
| ycsb-a-zipfian | 1.581× worst of 4 namespace(s) · blob: n/a (no blob activity) |
| ycsb-b-zipfian | 1.619× worst of 4 namespace(s) · blob: n/a (no blob activity) |
...
nils = 0
ops_per_sec = 20886
combined_client p50_us = 2111 · p99_us = 21503 · p999_us = 90111 · max_us = 1057761
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.22%
stream_checksum = 0x4df190400a169fc8
...
tiering_cold_p99_us (worst cell) = 15615
tiering_cold_p999_us (worst cell) = 73727
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 20291978
...
nils = 0
ops_per_sec = 13956
combined_client p50_us = 3071 · p99_us = 34815 · p999_us = 139263 · max_us = 2507379
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 71.21%
stream_checksum = 0x0b60d7a602d961ad
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 1119
tiering_cold_p99_us (worst cell) = 14847
tiering_cold_p999_us (worst cell) = 61439
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 30604146
tripwire sqes/submit = 7.7
```
