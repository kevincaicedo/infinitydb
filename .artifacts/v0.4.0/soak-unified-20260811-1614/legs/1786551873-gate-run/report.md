...
date: 1786551873 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +52.9%) — absolutes understate the server; deltas remain valid at fixed generator config
...
|---|---|
| ycsb-a-zipfian | 1.117× worst of 4 namespace(s) · blob: n/a (no blob activity) |
| ycsb-b-zipfian | 1.117× worst of 4 namespace(s) · blob: n/a (no blob activity) |
...
nils = 0
ops_per_sec = 8585
combined_client p50_us = 1279 · p99_us = 118783 · p999_us = 516095 · max_us = 3563088
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 72.23%
stream_checksum = 0xbbe89ca488328bfb
...
tiering_cold_resolves = 140471157
memory-hit split (client-derived, ADR-0071 D2):
  cold_frac = 8.6703% (cold_reads 446606 · cold_resolves 893227 — re-resolve ratio 2.00×)
...
nils = 0
ops_per_sec = 8695
combined_client p50_us = 1471 · p99_us = 104447 · p999_us = 466943 · max_us = 2765477
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 72.23%
stream_checksum = 0x8191ecb10a81c0da
tiering_cold_p50_us (worst cell) = 1279
tiering_cold_p99_us (worst cell) = 65535
tiering_cold_p999_us (worst cell) = 344063
cold_read_qd_p99 (worst cell) = 4
coalesce_ratio_milli (worst cell) = 0
server ram-hit fields: WITHDRAWN — tiering_ram_hit_p50_us, tiering_ram_hit_p99_us, tiering_ram_hit_p999_us named-absent, server says `unmeasured-iteration-clock`; the reactor's per-iteration clock cannot time a non-suspending command (ADR-0064 amendment 2026-08-08). The memory-hit half below is client-derived.
tiering_cold_resolves = 142081732
memory-hit split (client-derived, ADR-0071 D2):
  cold_frac = 8.6696% (cold_reads 452291 · cold_resolves 904584 — re-resolve ratio 2.00×)
  mem_hit p50_us = 1311 · p99_us = 16127 · p999_us = 17407
