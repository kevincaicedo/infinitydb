...
date: 1786729015 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- dataset: 20971520 keys × 1024 B = 20480 MiB = 10× the 2048 MiB memory budget · seed 0xdb5c47d5c · θ 0.99
...
| ycsb-b-zipfian | 1.466× worst of 4 namespace(s) · blob: n/a (no blob activity) |
...
nils = 0
ops_per_sec = 5008
combined_client p50_us = 2879 · p99_us = 192511 · p999_us = 786431 · max_us = 5826659
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 72.26%
stream_checksum = 0xf67d9a0e65748099
...
tiering_cold_resolves = 96024475
memory-hit split (client-derived, ADR-0071 D2):
  cold_frac = 20.6217% (cold_reads 619714 · cold_resolves 1548629 — re-resolve ratio 2.50×)
...
nils = 0
ops_per_sec = 7033
combined_client p50_us = 2175 · p99_us = 126975 · p999_us = 499711 · max_us = 4153536
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 72.25%
stream_checksum = 0xe2893e77efac01c9
tiering_cold_p50_us (worst cell) = 1343
tiering_cold_p99_us (worst cell) = 62463
tiering_cold_p999_us (worst cell) = 368639
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 0
server ram-hit fields: WITHDRAWN — tiering_ram_hit_p50_us, tiering_ram_hit_p99_us, tiering_ram_hit_p999_us named-absent, server says `unmeasured-iteration-clock`; the reactor's per-iteration clock cannot time a non-suspending command (ADR-0064 amendment 2026-08-08). The memory-hit half below is client-derived.
tiering_cold_resolves = 98292512
memory-hit split (client-derived, ADR-0071 D2):
  cold_frac = 14.1162% (cold_reads 595786 · cold_resolves 1209007 — re-resolve ratio 2.03×)
  mem_hit p50_us = 1855 · p99_us = 9215 · p999_us = 10239
  separation: mem_hit p99.9 10239 µs vs server cold p50 1343 µs (client tail spread 8384 µs — the truncation only separates the two modes while cold service exceeds it)
  NOT gate-eligible — separation check FAILED: derived memory-hit p99.9 10239 µs >= server cold p50 1343 µs — the two populations overlap and the quantile truncation cannot tell them apart (client tail spread 8384 µs vs cold service 1343 µs)
tripwire sqes/submit = 6.1
```
