...
date: 1786805757 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- dataset: 20971520 keys × 1024 B = 20480 MiB = 10× the 2048 MiB memory budget · seed 0x2d3ad1bb9f · θ 0.99
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s +43.2%) — absolutes understate the server; deltas remain valid at fixed generator config
...
|---|---|
| ycsb-a-zipfian | 1.488× worst of 4 namespace(s) · blob: n/a (no blob activity) |
| ycsb-b-zipfian | 1.491× worst of 4 namespace(s) · blob: n/a (no blob activity) |
...
nils = 0
ops_per_sec = 5046
combined_client p50_us = 3135 · p99_us = 184319 · p999_us = 1081343 · max_us = 6701543
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 72.26%
stream_checksum = 0xdaca0a19c91e257f
...
tiering_cold_resolves = 321243225
memory-hit split (client-derived, ADR-0071 D2):
  cold_frac = 32.5755% (cold_reads 987017 · cold_resolves 2146150 — re-resolve ratio 2.17×)
  mem_hit p50_us = 2303 · p99_us = 4223 · p999_us = 4351
...
nils = 0
ops_per_sec = 6462
combined_client p50_us = 2431 · p99_us = 131071 · p999_us = 933887 · max_us = 7255273
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 72.25%
stream_checksum = 0x8994df10d4f2857c
tiering_cold_p50_us (worst cell) = 1343
tiering_cold_p99_us (worst cell) = 63487
tiering_cold_p999_us (worst cell) = 368639
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 0
server ram-hit fields: WITHDRAWN — tiering_ram_hit_p50_us, tiering_ram_hit_p99_us, tiering_ram_hit_p999_us named-absent, server says `unmeasured-iteration-clock`; the reactor's per-iteration clock cannot time a non-suspending command (ADR-0064 amendment 2026-08-08). The memory-hit half below is client-derived.
tiering_cold_resolves = 324294076
memory-hit split (client-derived, ADR-0071 D2):
  cold_frac = 22.9725% (cold_reads 890680 · cold_resolves 1541896 — re-resolve ratio 1.73×)
