...
date: 1786804253 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- dataset: 20971520 keys × 1024 B = 20480 MiB = 10× the 2048 MiB memory budget · seed 0x2c9c9a41ee · θ 0.99
...
| Write amplification, worst tiered namespace | < 3 x user bytes (wal + flush) | 1.49 | PASS |
...
| ycsb-b-zipfian | 1.486× worst of 4 namespace(s) · blob: n/a (no blob activity) |
...
nils = 0
ops_per_sec = 4772
combined_client p50_us = 3199 · p99_us = 192511 · p999_us = 999423 · max_us = 5817822
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 72.24%
stream_checksum = 0x60a153510dd6f006
...
tiering_cold_resolves = 316047365
memory-hit split (client-derived, ADR-0071 D2):
  cold_frac = 33.6581% (cold_reads 964204 · cold_resolves 2076209 — re-resolve ratio 2.15×)
...
nils = 0
ops_per_sec = 6793
combined_client p50_us = 2431 · p99_us = 118783 · p999_us = 851967 · max_us = 7668766
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 72.23%
stream_checksum = 0x5e48076bbc6415c9
tiering_cold_p50_us (worst cell) = 1343
tiering_cold_p99_us (worst cell) = 63487
tiering_cold_p999_us (worst cell) = 368639
cold_read_qd_p99 (worst cell) = 5
coalesce_ratio_milli (worst cell) = 0
server ram-hit fields: WITHDRAWN — tiering_ram_hit_p50_us, tiering_ram_hit_p99_us, tiering_ram_hit_p999_us named-absent, server says `unmeasured-iteration-clock`; the reactor's per-iteration clock cannot time a non-suspending command (ADR-0064 amendment 2026-08-08). The memory-hit half below is client-derived.
tiering_cold_resolves = 319097075
memory-hit split (client-derived, ADR-0071 D2):
  cold_frac = 24.1575% (cold_reads 984626 · cold_resolves 1726602 — re-resolve ratio 1.75×)
  mem_hit p50_us = 1887 · p99_us = 4223 · p999_us = 4223
