...
date: 1783358762 (unix) · cells: 4 · duration: 10s · ONLY-ALWAYS (M2.5-S07 A/B leg; sync-pipeline 1)
...
- always row: 1694115 gated acks / 17111 fsyncs = ratio 99.0; fsync latency p50/p99/p999 = 2495/4223/6655 us (HDR ~3% quantization); log_writes_per_iter 0.028 (71045 frames / 2574336 iterations); group formation p50/p99 = 99/135 records vs ~256 available in-flight writes/cell = 0.39x (M2.5-S07 gate: >= 0.8x)
...
| always grouped writes | >= 300000 w/s | 154176.37 | FAIL (DEV-TIER, non-binding) |
...
| acks/fsync grouping ratio above floor | >= 2 acks per fsync | 99.01 | PASS (informational) |
