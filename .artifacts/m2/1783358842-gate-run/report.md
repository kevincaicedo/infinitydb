...
date: 1783358842 (unix) · cells: 4 · duration: 10s · ONLY-ALWAYS (M2.5-S07 A/B leg; sync-pipeline 1)
...
- always row: 1720052 gated acks / 17286 fsyncs = ratio 99.5; fsync latency p50/p99/p999 = 2495/4031/5247 us (HDR ~3% quantization); log_writes_per_iter 0.028 (71702 frames / 2539520 iterations); group formation p50/p99 = 101/135 records vs ~256 available in-flight writes/cell = 0.39x (M2.5-S07 gate: >= 0.8x)
...
| always grouped writes | >= 300000 w/s | 156472.76 | FAIL (DEV-TIER, non-binding) |
...
| acks/fsync grouping ratio above floor | >= 2 acks per fsync | 99.51 | PASS (informational) |
