...
date: 1783358746 (unix) · cells: 4 · duration: 10s · ONLY-ALWAYS (M2.5-S07 A/B leg; sync-pipeline 2)
...
- always row: 1639152 gated acks / 29402 fsyncs = ratio 55.7; fsync latency p50/p99/p999 = 2751/5631/7935 us (HDR ~3% quantization); log_writes_per_iter 0.025 (81629 frames / 3294208 iterations); group formation p50/p99 = 59/171 records vs ~256 available in-flight writes/cell = 0.23x (M2.5-S07 gate: >= 0.8x)
...
| always grouped writes | >= 300000 w/s | 149635.89 | FAIL (DEV-TIER, non-binding) |
...
| acks/fsync grouping ratio above floor | >= 2 acks per fsync | 55.75 | PASS (informational) |
