...
date: 1783358858 (unix) · cells: 4 · duration: 10s · ONLY-ALWAYS (M2.5-S07 A/B leg; sync-pipeline 2)
...
- always row: 1646116 gated acks / 29669 fsyncs = ratio 55.5; fsync latency p50/p99/p999 = 2751/5503/7551 us (HDR ~3% quantization); log_writes_per_iter 0.025 (80524 frames / 3269632 iterations); group formation p50/p99 = 58/171 records vs ~256 available in-flight writes/cell = 0.23x (M2.5-S07 gate: >= 0.8x)
...
| always grouped writes | >= 300000 w/s | 149976.52 | FAIL (DEV-TIER, non-binding) |
...
| acks/fsync grouping ratio above floor | >= 2 acks per fsync | 55.48 | PASS (informational) |
