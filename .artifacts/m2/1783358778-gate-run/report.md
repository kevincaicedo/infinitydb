...
date: 1783358778 (unix) · cells: 4 · duration: 10s · ONLY-ALWAYS (M2.5-S07 A/B leg; sync-pipeline 1)
...
- always row: 1703234 gated acks / 17210 fsyncs = ratio 99.0; fsync latency p50/p99/p999 = 2495/4095/6271 us (HDR ~3% quantization); log_writes_per_iter 0.028 (71838 frames / 2586624 iterations); group formation p50/p99 = 99/135 records vs ~256 available in-flight writes/cell = 0.39x (M2.5-S07 gate: >= 0.8x)
...
| always grouped writes | >= 300000 w/s | 154739.69 | FAIL (DEV-TIER, non-binding) |
...
| acks/fsync grouping ratio above floor | >= 2 acks per fsync | 98.97 | PASS (informational) |
