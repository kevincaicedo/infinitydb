...
date: 1781300794 (unix) · cells: 4 · replicates: 3 · duration: 10s
...
- attribution: domains 1098908224 B vs VmRSS 1126760448 B (2.5% divergence)

| gate | threshold | measured | verdict |
|---|---|---|---|
| Pipelined GET/SET node throughput | >= 6000000 ops/s | 3602107.19 | FAIL (DEV-TIER, non-binding) |
| Unpipelined throughput vs Redis, 512 conns | >= 1.5 x Redis | 2.69 | PASS (DEV-TIER, non-binding) |
| io_uring SQEs per submit under pipelined load | >= 16 sqes/submit | 13.29 | FAIL |
...
| Cross-cell penalty, uniform random keys (informational; M1 S17 target) | <= 50 % vs all-local | 54.06 | FAIL (informational) |
| p99.9 latency (memtier, 8 threads) | < 3000 us | 1343.00 | PASS (DEV-TIER, non-binding) |
