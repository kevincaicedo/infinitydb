...
date: 1786054692 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
|---|---|
| ycsb-a-zipfian | 1.647× worst of 4 namespace(s) · blob: n/a (no blob activity) |
...
nils = 0
ops_per_sec = 120882
combined_client p50_us = 383 · p99_us = 4031 · p999_us = 13311 · max_us = 563946
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 66.08%
stream_checksum = 0x455b6e5a0edb099e
...
tiering_cold_p999_us (worst cell) = 5247
cold_read_qd_p99 (worst cell) = 6
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 159351481
...
nils = 0
ops_per_sec = 163845
combined_client p50_us = 351 · p99_us = 1151 · p999_us = 3903 · max_us = 294301
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 66.08%
stream_checksum = 0x72d83421757bc3ee
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 179
...
cold_read_qd_p99 (worst cell) = 6
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 233534743
tripwire sqes/submit = 1.4
```
