...
date: 1786053189 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 600s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
- saturation (ycsb-a-zipfian): generator unsaturated at 8 conns (+50% conns moved ops/s -2.3%)
...
| Cold reads: p99 < 1.5 ms on NVMe under loaded zipfian rows | < 1.5 ms, cold-read split histogram, worst loaded row | 0.62 | PASS (DEV-TIER, non-binding) |
...
|---|---|
| ycsb-a-zipfian | 1.644× worst of 4 namespace(s) · blob: n/a (no blob activity) |
| ycsb-b-zipfian | 1.647× worst of 4 namespace(s) · blob: n/a (no blob activity) |
...
nils = 0
ops_per_sec = 163938
combined_client p50_us = 351 · p99_us = 1151 · p999_us = 3583 · max_us = 161128
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 66.08%
stream_checksum = 0x61a0221292141158
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 179
tiering_cold_p99_us (worst cell) = 559
tiering_cold_p999_us (worst cell) = 4735
cold_read_qd_p99 (worst cell) = 6
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 113694791
