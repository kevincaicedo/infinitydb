...
date: 1786055274 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 32s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
env-check: OK
...
|---|---|
| ycsb-a-zipfian | 1.650× worst of 4 namespace(s) · blob: n/a (no blob activity) |
...
nils = 0
ops_per_sec = 120430
combined_client p50_us = 391 · p99_us = 3839 · p999_us = 14335 · max_us = 73295
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 66.07%
stream_checksum = 0x3e38fa0b3691ea80
...
tiering_cold_resolves = 274776005
...
nils = 0
ops_per_sec = 161450
combined_client p50_us = 351 · p99_us = 1247 · p999_us = 3583 · max_us = 15945
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 66.06%
stream_checksum = 0xc3eed56ffc8c9546
tiering_ram_hit_p50_us (worst cell) = 0
tiering_ram_hit_p99_us (worst cell) = 0
tiering_ram_hit_p999_us (worst cell) = 0
tiering_cold_p50_us (worst cell) = 179
...
cold_read_qd_p99 (worst cell) = 6
coalesce_ratio_milli (worst cell) = 1000
tiering_cold_resolves = 278801608
tripwire sqes/submit = 1.4
```
