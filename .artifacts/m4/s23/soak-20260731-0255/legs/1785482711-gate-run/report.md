...
date: 1785482711 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 99s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
...
nils = 0
ops_per_sec = 981496
combined_client p50_us = 46 · p99_us = 127 · p999_us = 1087 · max_us = 1372778
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 66.08%
stream_checksum = 0x73eb9bb5104a0574
...
nils = 0
ops_per_sec = 1314175
combined_client p50_us = 43 · p99_us = 115 · p999_us = 239 · max_us = 276559
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 66.08%
stream_checksum = 0x9db1476ca610356d
memory-hit / cold split: NAMED-ABSENT — the tiered data plane is behind the ADR-0062 D8 refusal; M4-S26 emits the split service histograms (resolver-tagged {mutable, ro, cold}) under the SPLIT_FIELDS names
tripwire sqes/submit = 2.9
```
