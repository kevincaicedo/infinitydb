...
date: 1785482752 (unix) · cells: 4 · conns: 8 · pipeline: 8 · duration: 15s · dataset: 10× budget · ycsb rows: 2 (M4-S22)
...
- saturation (ycsb-a-zipfian): GENERATOR-LIMITED at 8 conns (+50% moved ops/s -5.6%) — absolutes understate the server; deltas remain valid at fixed generator config
...
nils = 0
ops_per_sec = 1221622
combined_client p50_us = 42 · p99_us = 121 · p999_us = 1055 · max_us = 313202
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 66.09%
stream_checksum = 0x65c503b260600c1a
...
nils = 0
ops_per_sec = 1357304
combined_client p50_us = 41 · p99_us = 115 · p999_us = 235 · max_us = 10804
(combined = context only; the split section below is the honest read)
hot_share_top1pct = 66.08%
stream_checksum = 0xb1b3a1bace16c987
memory-hit / cold split: NAMED-ABSENT — the tiered data plane is behind the ADR-0062 D8 refusal; M4-S26 emits the split service histograms (resolver-tagged {mutable, ro, cold}) under the SPLIT_FIELDS names
tripwire sqes/submit = 2.9
```
